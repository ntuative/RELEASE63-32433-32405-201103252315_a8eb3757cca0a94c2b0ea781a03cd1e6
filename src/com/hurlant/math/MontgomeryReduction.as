package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1858 = param1.invDigit();
         this.var_1859 = this.var_1858 & 32767;
         this.var_2608 = this.var_1858 >> 15;
         this.var_2607 = 131071;
         this.var_2609 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_163) > 0)
         {
