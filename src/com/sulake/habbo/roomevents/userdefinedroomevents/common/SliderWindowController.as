package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_656:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1232,param1);
         this.var_997 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_997);
         }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_998)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_197)
            {
               this.var_998 = false;
            }
         }
         if(!this.var_998 || param1.type != WindowEvent.const_358)
         {
            return;
         }
         if(this.var_656 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_656) * this.var_656;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_656 != 0)
            {
               _loc3_ = this.var_997 + this.var_656;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_732 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_732.width,this.var_732.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_732,this.var_732.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1715 = _loc1_.width - _loc2_.width;
            }
         }
