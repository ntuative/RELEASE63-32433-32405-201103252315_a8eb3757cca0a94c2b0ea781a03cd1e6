package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         return ConditionCodes.var_2038;
      }
      ...
      {
         this.var_83 = param2;
         this.var_1229 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1229.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1229.setValue(1);
         this.var_1230 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1230.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1230.setValue(50);
      }
