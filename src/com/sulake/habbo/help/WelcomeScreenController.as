package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_350:Point;
      
      private var var_715:Timer;
      
      private var _hilites:Array;
      ...
      {
         this.var_350 = new Point(72,10);
         this._hilites = [new WelcomeScreenHilite(HabboToolbarIconEnum.NAVIGATOR,"welcome.screen.title","welcome.screen.message")];
         super();
         this.var_133 = param1;
      ...
      public function set hilites(param1:Array) : void
      {
         this._hilites = param1;
      }
      ...
      private function get current() : WelcomeScreenHilite
      {
         return this._hilites[this.var_1344];
      }
      
      public function dispose() : void
      {
         this.var_133.removeUpdateReceiver(this);
         if(this.var_133)
         {
            this.var_133.toolbar.events.removeEventListener(HabboToolbarEvent.const_38,this.onToolbarClicked);
            this.var_133.toolbar.events.removeEventListener(HabboToolbarEvent.const_690,this.onToolbarResized);
            this.var_133 = null;
         }
         ...
         {
            this.var_715.stop();
            this.var_715.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_715 = null;
         }
         this._hilites = null;
         this._disposed = true;
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_133.toolbar.events.addEventListener(HabboToolbarEvent.const_38,this.onToolbarClicked);
         this.var_133.toolbar.events.addEventListener(HabboToolbarEvent.const_690,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_715 = new Timer(_loc4_);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_350.y = this.var_133.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_350.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_133.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_133.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_334,false);
         _loc4_.height -= 20;
      ...
      private function highlightToolbarIcon(param1:Boolean) : void
      {
         ...
         this.var_133.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1344 < this._hilites.length - 1)
         {
            ++this.var_1344;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_350);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_350,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_350.x;
            this._window.y = this.var_350.y;
            this.var_133.removeUpdateReceiver(this);
         }
      }
      ...
      private function hasBlockingWindow() : Boolean
      {
         ...
         while(_loc1_ <= 2)
         {
            _loc2_ = ICoreWindowManager(this._windowManager).getDesktop(_loc1_);
      ...
      {
         this.var_133.removeUpdateReceiver(this);
         this.var_133.registerUpdateReceiver(this,10);
      }
   }
}
