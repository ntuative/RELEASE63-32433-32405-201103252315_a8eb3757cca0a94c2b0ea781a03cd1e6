package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_304:String = "TUI_NAME_VIEW";
      
      public static const const_417:String = "TUI_CLOTHES_VIEW";
      
      public static const const_447:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_363:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_581,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_494,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_513,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_296,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1154 && this.var_1155 && this.var_1414;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_581,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_494,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_513,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_296,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_581:
               this.var_1414 = true;
               if(this.var_44 != null && this.var_44.id == const_447)
               {
                  this.showView(const_88);
               }
               break;
            case HabboHelpTutorialEvent.const_494:
               if(this.var_44 != null && this.var_44.id == const_417)
               {
                  this.var_1747 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2112 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_304:
               ...
               if(this.var_363 == null)
               {
                  this.var_363 = new NameChangeView(this);
               }
               this.var_363.showMainView();
               this.prepareForTutorial();
               break;
            case const_417:
         ...
         this._window.height = _loc2_.height + this.var_2114;
         this._window.width = _loc2_.width + this.var_2112;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_34.hideUI();
         this.var_34.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_115));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_44 != null && (this.var_44.id == const_304 || this.var_44.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      {
         this.var_1154 = true;
         if(this.var_44 != null && (this.var_44.id == const_417 || this.var_44.id == const_88))
         {
            this.showView(const_88);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_363.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_558)
         {
            this.var_363.checkedName = _loc2_.name;
         }
         else
         {
            this.var_363.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
