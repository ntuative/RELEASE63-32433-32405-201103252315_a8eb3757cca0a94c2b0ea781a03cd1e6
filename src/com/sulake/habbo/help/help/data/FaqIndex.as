package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_789 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_788 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_787 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_789.hasItem(param1))
         {
            this.var_789.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_789.hasItem(param1))
         {
            return this.var_789.getItem(param1);
         }
         if(this.var_788.hasItem(param1))
         {
