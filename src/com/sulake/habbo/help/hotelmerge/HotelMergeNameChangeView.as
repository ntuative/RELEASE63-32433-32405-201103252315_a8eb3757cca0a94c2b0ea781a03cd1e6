package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_709)
         {
            this.var_709 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_709)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_708)
         {
            this.var_708 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_708)
            {
               return;
            }
