package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1928:GroupDetailsView;
      ...
      private var var_662:ProductDataParser;
      ...
      private var var_1930:UserTagManager;
      
      private var var_1506:BadgeImageManager;
      
      private var var_1245:HabboGroupInfoManager;
      ...
      private var var_1244:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_2892 = [];
         this.var_1930 = new UserTagManager(events);
         this.var_1245 = new HabboGroupInfoManager(this,events);
         this.var_1003 = new IgnoredUsersManager(this);
         this.var_1244 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_324)
         {
            this.var_324.removeEventListener(FurnitureDataParser.const_111,this.onFurnitureReady);
            this.var_324.dispose();
            this.var_324 = null;
         }
         if(this.var_662)
         {
            this.var_662.removeEventListener(ProductDataParser.const_111,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1506 = new BadgeImageManager(context.root.assets,events,this.var_195,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1930.communication = this._communication;
         this.var_1245.communication = this._communication;
         this.var_1244.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_324)
         {
            ...
            this.var_324 = new FurnitureDataParser(this.var_549,this._wallItems,this.var_548,this._localization);
            this.var_324.addEventListener(FurnitureDataParser.const_111,this.onFurnitureReady);
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2679 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_818 = _loc3_.petRespectLeft;
         this.var_676 = _loc3_.figure;
         this.var_1021 = _loc3_.sex;
         this.var_1649 = _loc3_.realName;
         this.var_2676 = _loc3_.identityId;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_676 = _loc2_.figure;
            this.var_1021 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_676,this.var_1021));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2726 = _loc2_.isOpen;
         this.var_2727 = _loc2_.onShutDown;
      }
      ...
      {
         return this._securityLevel >= SecurityLevelEnum.const_1243;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1930.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1506.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1928 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1245.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1928.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1245.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1245.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1506.getBadgeImage(param1,BadgeImageManager.const_1206);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_818 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_818 = this.var_818 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_549.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_548.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_1243.indexOf(param1) == -1)
         {
         ...
         if(this.var_662 == null)
         {
            ...
            this.var_662 = new ProductDataParser(_loc2_,this.var_1092);
            this.var_662.addEventListener(ProductDataParser.const_111,this.onProductsReady);
         }
         return false;
      }
      ...
      private function onProductsReady(param1:Event) : void
      {
         ...
         this.var_662.removeEventListener(ProductDataParser.const_111,this.onProductsReady);
         this.var_1929 = true;
         for each(_loc2_ in this.var_1243)
         {
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_549.getValues();
