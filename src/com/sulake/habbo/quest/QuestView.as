package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private function createView() : void
      {
         switch(this.var_64.type)
         {
            ...
            case QuestTypeEnum.SWITCH_ITEM_STATE:
               this.var_17 = this.var_65.controller.questEngine.getXmlWindow("QuestTypeBasic");
               this.var_2579 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this.var_17)
               {
      ...
      public function onActivateQuest(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(this.var_64)
         {
            this.var_65.controller.activateQuest(this.var_64);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc38_:* = null;
         var _loc39_:* = null;
         var _loc1_:String = ["quest",this.var_65.code,this.var_64.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_65.code,"type_" + this.var_64.type.toLowerCase()].join(".");
         ...
         if(this.var_64.type == QuestTypeEnum.FIND_STUFF)
         {
            ...
            _loc37_ = this.var_65.controller.questEngine.sessionDataManager.getFloorItemDataByName(_loc35_,_loc36_);
            if(_loc37_)
            {
               _loc39_ = "";
               _loc38_ = this.var_65.controller.questEngine.roomEngine.getFurnitureImage(_loc37_.id,new Vector3d(90,0,0),64,this,_loc36_,_loc39_);
               this.var_637 = _loc38_.id;
               if(_loc38_ && _loc38_.data)
               {
                  this.imageReady(_loc38_.id,_loc38_.data);
               }
               this.var_65.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc37_.title);
            }
         }
         else if(this.var_64.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_65.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_64.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_65.controller.questEngine.setImageFromAsset(_loc15_,this.var_64.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         ...
         {
            case QuestStatusEnum.const_355:
            ...
            case QuestStatusEnum.const_201:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_679:
               this.setText("quest.status","quest.completed");
               _loc17_.visible = true;
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_195:
         ...
         this.var_65.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_64.rewardCurrencyAmount.toString());
         ...
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","day",_loc20_.toString());
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","month",_loc21_.toString());
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","year",_loc22_.toString());
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","12h",this.pad(_loc25_));
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","24h",this.pad(_loc24_));
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","ampm",_loc26_);
         this.var_65.controller.questEngine.localization.registerParameter("quest.available","minute",this.pad(_loc23_));
         ...
         var _loc30_:String = "header_" + this.var_65.code;
         this.var_65.controller.questEngine.setImageFromAsset(_loc29_,_loc30_,this.onHeaderImageReady);
         var _loc31_:IBitmapWrapperWindow = this.find("quest.reward.icon") as IBitmapWrapperWindow;
         var _loc32_:String = "icon_" + this.var_65.code + "_reward_" + this.var_64.rewardCurrencyAmount;
         this.var_65.controller.questEngine.setImageFromAsset(_loc31_,_loc32_,this.onRewardImageReady);
         this.updateMargins();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_709;
            }
         }
      }
      ...
      private function onHeaderImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_65.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onHeaderImageReady);
         }
      }
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_65.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onPreviewImageReady);
         }
      }
