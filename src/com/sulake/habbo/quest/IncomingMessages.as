package com.sulake.habbo.quest
{
   ...
   import com.sulake.habbo.help.WelcomeScreenHilite;
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1640:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_55 = param1;
         this._communication = this.var_55.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_55.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests,_loc2_.isPushMessage);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_55.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_55.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:String = this.var_55.configuration.getKey("questing.excludedCampaignCode","");
         if(this.var_55.defaultCampaignCode == _loc4_)
         {
            this.var_55.defaultCampaignCode = "";
         }
         ...
         else
         {
            ...
            this.var_55.controller.openCampaigns(_loc3_);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_55.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(this.var_55.toolbar != null && this.var_55.configuration != null)
         {
            this.var_55.defaultCampaignCode = this.getCampaignCode();
            this._communication.getHabboMainConnection(null).send(new GetAvailableQuestCampaignsMessageComposer());
         }
         this.var_55.inRoom = true;
      }
      
      private function getCampaignCode() : String
      {
         var _loc1_:String = this.var_55.configuration.getKey("questing.defaultCampaign","");
         var _loc2_:String = this.var_55.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_55.configuration.getKey("questing.excludedCampaignCode","");
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_55.toolbar != null)
         {
            if(param1)
            {
               _loc2_ = this.var_55.defaultCampaignCode;
               _loc3_ = _loc2_.length > 0 && _loc2_ == this.var_55.configuration.getKey("questing.defaultCampaign.override","");
               _loc4_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_93,HabboToolbarIconEnum.QUESTS);
               _loc4_.iconState = "0";
               this.var_55.toolbar.events.dispatchEvent(_loc4_);
               if(this.var_55.habboHelp && _loc3_)
               {
                  _loc5_ = [new WelcomeScreenHilite(HabboToolbarIconEnum.QUESTS,"welcome.screen.title.questing","welcome.screen.message.questing"),new WelcomeScreenHilite(HabboToolbarIconEnum.NAVIGATOR,"welcome.screen.title.navigator","welcome.screen.message")];
                  this.var_55.habboHelp.setWelcomeScreenHilites(_loc5_);
               }
               this._communication.getHabboMainConnection(null).send(new GetExpiredQuestCampaignsMessageComposer());
            }
            else
            {
               this.var_55.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      {
         this.var_55.controller.close();
         this.var_55.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.QUESTS));
         this.var_55.inRoom = false;
         this.var_55.controller.closeReminderOnExitRoom();
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_55.controller.updatePurse();
      }
