package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_853:int = 0;
      
      protected var var_689:BitmapData;
      
      protected var var_2593:int;
      
      protected var var_1561:Boolean;
      
      protected var var_2077:Boolean;
      
      protected var var_2851:BitmapData;
      
      private const const_2049:int = 8947848;
      
      private const const_2050:int = 13421772;
      
      private const const_1774:Number = 1;
      
      private const const_1775:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2852 == FurniModel.const_44)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1316));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2075);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_909)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_1774;
               _loc1_.blend = this.const_1774;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2077 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2851;
               _loc5_.visible = true;
            }
            else
            {
