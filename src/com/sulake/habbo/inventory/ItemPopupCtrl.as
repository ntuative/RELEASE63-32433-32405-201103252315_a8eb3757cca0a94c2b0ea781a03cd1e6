package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1331:int = 250;
      
      private static const const_1330:int = 100;
      
      private static const const_1333:int = 180;
      
      private static const const_1332:int = 200;
      ...
      {
         this.var_366 = new Timer(const_1331,1);
         this.var_367 = new Timer(const_1330,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_760 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1333,param3.width),Math.min(const_1332,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1777);
         switch(this.var_1777)
         {
            case const_1090:
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1090:
               ...
               break;
            case const_477:
               _loc2_.bitmap = this.var_760.clone();
               _loc2_.width = this.var_760.width;
               _loc2_.height = this.var_760.height;
               _loc2_.y = (this.var_81.height - this.var_760.height) / 2;
               _loc2_.x = -1 * this.var_760.width + 1;
         }
         _loc2_.invalidate();
      }
