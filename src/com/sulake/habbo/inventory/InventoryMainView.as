package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2867:IWindowContainer;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_180)
         {
            ...
            {
               this.var_180.events.removeEventListener(HabboToolbarEvent.const_72,this.onHabboToolbarEvent);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_180 != null && this.var_1087)
         {
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1600);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_711 == InventoryCategory.const_131)
            {
               this.toggleCategoryView(InventoryCategory.const_131);
            }
            else if(this.var_711 == InventoryCategory.const_78)
            {
