package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2051:int = 500;
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_51.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_331));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_698));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_51.getValue(InventoryCategory.const_306));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_51.getValue(InventoryCategory.const_418));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_131));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_370) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1419 = new IncomingMessages(this);
      ...
      {
         this.var_311 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         this.var_477 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_311 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_180 || !this.var_477)
         {
            return;
         }
         this.var_17 = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this.var_17.setToolbar(this.var_180);
         this.var_51 = new Map();
         ...
         this.var_51.add(InventoryCategory.const_370,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_477);
         this.var_51.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_311);
         this.var_51.add(InventoryCategory.const_306,_loc3_);
         ...
         this.var_51.add(InventoryCategory.const_698,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_311);
         this.var_51.add(InventoryCategory.const_418,_loc5_);
         var _loc6_:TradingModel = new TradingModel(this,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._localization,this.var_477);
         this.var_51.add(InventorySubCategory.const_331,_loc6_);
         ...
         this.var_51.add(InventoryCategory.const_131,_loc8_);
         this.var_197 = true;
         if(this.var_2486)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_938.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_938.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2051);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_786));
      }
