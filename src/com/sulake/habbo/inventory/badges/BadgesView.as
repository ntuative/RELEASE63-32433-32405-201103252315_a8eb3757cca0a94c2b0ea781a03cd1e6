package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1118 = this.var_17.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1118.procedure = this.inactiveGridEventProc;
         this.var_1119 = this.var_17.findChildByName("active_items") as IItemGridWindow;
         this.var_1119.procedure = this.activeGridEventProc;
      }
