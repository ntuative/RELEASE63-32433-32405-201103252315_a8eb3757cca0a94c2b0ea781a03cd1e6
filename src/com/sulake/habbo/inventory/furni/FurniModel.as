package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_404:String = "pets";
      
      private static const const_1432:int = 100;
      ...
      private var var_2005:Vector.<Array>;
      
      private var var_2004:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_477 = param8;
         this.var_683 = new Timer(const_1432,1);
         ...
         this.var_2814 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_17 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_477);
         this.var_17.switchCategory(const_44);
      }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_44)
            {
               ...
               {
                  this.var_2005 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2005;
            }
            else
            {
               if(this.var_2004 == null)
               {
                  this.var_2004 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2004;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_402)
         {
         ...
         else if(param3 == FurniCategory.const_392)
         {
         ...
         if(this.var_1032 == null)
         {
            this.var_1032 = this._windowManager.buildFromXML(this.var_2814) as IWindowContainer;
         }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_684.add(const_44,new Array());
         this.var_684.add(const_51,new Array());
         if(this.var_17 != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_203)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_331;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_402 || _loc3_.category == FurniCategory.const_377 || _loc3_.category == FurniCategory.const_392)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_684.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_909)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
