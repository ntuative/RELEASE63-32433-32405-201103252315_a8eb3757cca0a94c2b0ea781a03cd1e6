package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1622:uint = 9;
      
      public static const const_182:uint = 0;
      
      public static const const_208:uint = 1;
      
      public static const const_375:uint = 2;
      
      public static const const_322:uint = 3;
      
      public static const const_578:uint = 4;
      
      public static const const_237:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_57.updateItemList(this.var_755);
         this.var_57.updateItemList(this.var_1416);
      ...
      public function close() : void
      {
         if(this.var_759)
         {
            if(this._state != const_182 && this._state != const_237)
            {
      ...
      {
         this.var_57.setMinimized(param1 != InventoryCategory.const_78);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_756 + " OTHER: " + this.var_1158);
         ...
         {
            case const_182:
               if(param1 == const_208 || param1 == const_237)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_57.alertPopup(TradingView.const_1135);
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_57.alertPopup(TradingView.const_1254);
            }
            this.close();
         }
         ...
         {
            this.var_57.method_4("${inventory.trading.warning.own_account_disabled}");
         }
         else
         {
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_253.length < const_1622)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_203)
            {
