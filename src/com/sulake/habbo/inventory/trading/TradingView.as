package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_945:uint = 4284532064;
      
      private static const const_944:uint = 2577770;
      
      public static const const_1134:int = 0;
      
      public static const const_1254:int = 1;
      
      public static const const_1135:int = 2;
      ...
      private var var_585:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_585 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function setup(param1:int, param2:Boolean, param3:int, param4:Boolean) : void
      {
         ...
         else
         {
            if(!param2)
            {
               this.method_4("${inventory.trading.warning.own_account_disabled}");
            }
            if(!param4)
            {
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1618 = this.createMinimizedWindow();
         }
         if(!this.var_2224)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_945) : uint(const_944);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_945) : uint(const_944);
            }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1675)
            {
            ...
            this.var_585.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_477);
            this.var_585.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_585.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         var _loc7_:ISongInfo = this.var_477.musicController.getSongInfo(_loc6_.extra);
         if(_loc7_ != null)
         {
         ...
         else if(param3)
         {
            ...
            this.var_477.musicController.requestSongInfoWithoutSamples(_loc6_.extra);
         }
         return param2;
      }
         ...
         if(this.var_182.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_585.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_477);
               }
            }
            else
            {
