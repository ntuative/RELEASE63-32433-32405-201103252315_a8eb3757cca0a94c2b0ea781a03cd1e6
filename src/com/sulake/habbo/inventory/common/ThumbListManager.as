package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1427:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_617 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_617.width;
         this.var_93 = this.var_617.height;
         this.var_1166 = param5;
         this.var_944 = param6;
         this.var_223 = Math.floor(this.var_1166 / this._thumbWidth);
         this.var_27 = new BitmapData(this.var_1166,this.var_944);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_27 = new BitmapData(Math.max(this.var_223 * this._thumbWidth,this.var_1166),Math.max(this.var_618 * this.var_93,this.var_944),true,16777215);
            ...
            while(_loc4_ < this.var_223)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_27.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_93),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_223 && this.var_27.height < _loc3_.y * this.var_93)
         {
            _loc2_ = new BitmapData(this.var_27.width,this.var_27.height + this.var_93);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_223 - 1),this.var_93);
         ...
         _loc2_.copyPixels(this.var_27,_loc4_,new Point(0,this.var_93),null,null,true);
         _loc4_ = new Rectangle(0,this.var_93,this._thumbWidth * (this.var_223 - 1),this.var_27.height - this.var_93);
         _loc2_.copyPixels(this.var_27,_loc4_,new Point(this._thumbWidth,this.var_93),null,null,true);
         this.var_27 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1427.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < this.var_618 - 1)
         {
            ...
            _loc8_ = this.var_27.height - (param1.y + 1) * this.var_93;
            ...
            this.var_27.fillRect(new Rectangle(0,this.var_27.height - this.var_93,this.var_27.width,this.var_93),4294967295);
            _loc3_ = new Point(this.var_27.width - this._thumbWidth,_loc2_.y - this.var_93);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(this.var_27.width,this.var_27.height - this.var_93);
               _loc2_ = new Rectangle(0,0,this.var_27.width,this.var_27.height - this.var_93);
               _loc11_.copyPixels(this.var_27,_loc2_,new Point(0,0),null,null,true);
               this.var_27 = _loc11_;
               --this.var_618;
            }
         }
         if(this.var_27.height < this.var_944)
         {
            _loc12_ = new BitmapData(this.var_27.width,this.var_944);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_617.width,this.var_617.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_617.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_617,this.var_617.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
