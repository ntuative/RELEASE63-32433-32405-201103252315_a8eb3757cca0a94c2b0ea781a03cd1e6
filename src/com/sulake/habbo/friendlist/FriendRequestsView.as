package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1755:String = "no_reqs_info";
      ...
      {
         this.var_1607 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1608 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1608.procedure = this.onDismissAllButtonClick;
         this.var_1607.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1198)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_352 && _loc4_.state != FriendRequest.const_386)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1607,_loc1_);
         this.setEnabled(this.var_1608,_loc1_);
      }
