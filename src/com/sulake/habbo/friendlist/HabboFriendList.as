package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2385:FriendListLookAndFeel;
      
      private var var_407:FriendListTabs;
      
      private var var_17:FriendListView;
      
      private var var_1698:OpenedToWebPopup;
      
      private var var_2384:int;
      
      var var_104:FriendCategories;
      ...
      {
         this.var_2385 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_104 = new FriendCategories(new FriendCategoriesDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1698 = new OpenedToWebPopup(this);
         }
         this.var_1698.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_104.findFriend(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_104.getFriendCount(param1,param2);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_358.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_314,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1126.createAvatarImage(param1,AvatarScaleType.const_89,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_358 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_104.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_104.addCategory(new FriendCategory(FriendCategory.const_1046,this.getText("friendlist.friends")));
         this.var_104.addCategory(new FriendCategory(FriendCategory.const_372,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_104.addFriend(new Friend(_loc4_));
         }
         ...
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.FRIENDLIST));
         this.var_180.events.addEventListener(HabboToolbarEvent.const_38,this.onHabboToolbarEvent);
         if(this.var_104.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_104.findCategory(FriendCategory.const_372);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_358.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_358.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_407.findTab(FriendListTab.const_100).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_358.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_407.findTab(FriendListTab.const_100);
      ...
      {
         this.var_104.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_104.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_407.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_725 || !this.var_358)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_725.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_358.vipLimit;
         }
         else if(this.var_725.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_358.clubLimit;
         }
         if(_loc2_ > this.var_358.limit)
         {
            this.var_358.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(disposed || this.var_104 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_104.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
