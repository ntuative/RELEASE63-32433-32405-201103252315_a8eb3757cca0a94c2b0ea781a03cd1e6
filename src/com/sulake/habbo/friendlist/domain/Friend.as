package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1873:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_836 = param1.online;
         this.var_1733 = param1.followingAllowed && param1.online;
         this.var_676 = param1.figure;
         this.var_1650 = param1.motto;
         this.var_1652 = param1.lastAccess;
         this.var_1350 = param1.categoryId;
         this.var_1649 = param1.realName;
