package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1756:String = "noconvinfo";
      
      private static const const_1757:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1351:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1351 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1351.prepare(this.var_966);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1031,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1021,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_815,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_912,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_815,false);
         ...
         this.var_1352 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1352.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:int = this.var_1638 == -1 ? 0 : int(this.var_16.width - this.var_1638);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1149,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_815,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1031,false);
         ...
         this.var_1638 = this.var_16.width;
