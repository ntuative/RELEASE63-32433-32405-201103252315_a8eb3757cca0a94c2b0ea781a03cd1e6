package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_890:TextFieldManager;
      
      private var var_889:TextFieldManager;
      
      private var var_1107:TextFieldManager;
      
      private var var_1102:ICheckBoxWindow;
      
      private var var_1109:ICheckBoxWindow;
      
      private var var_1103:ICheckBoxWindow;
      ...
      private var var_1105:IWindowContainer;
      
      private var var_1670:IWindowContainer;
      ...
      {
         if(param1 != this.var_351 || this.var_1104 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1104 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1710)
         {
            this.var_716.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1592)
         {
            this.var_716.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         {
            this.setTagError(this.var_891,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_890,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1470)
         {
            this.setTagError(this.var_891,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_890,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1550)
         {
            this.var_889.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_716.displayError("Update failed: error " + param2);
         }
      }
      ...
      {
         this.var_716.clearErrors();
         this.var_1110.clearErrors();
         this.var_891.clearErrors();
         this.var_890.clearErrors();
         this.var_889.clearErrors();
         this.var_1107.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_463,this.onDoorModePasswordSelect);
         ...
         this.var_716 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1110 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_891 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_890 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_889 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1107 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1102 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1109 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1103 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_593 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1669 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1365 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1106 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1105 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1670 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_1108 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2313 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2312 = ITextWindow(this._window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1669.visible = this._inRoom;
         this.var_1670.visible = this._inRoom;
         this.var_2312.visible = this.var_489;
         this.var_2313.visible = !this.var_489;
         if(this.var_489)
         {
            this.var_1105.visible = true;
            this.var_1363.visible = false;
            this.refreshFlatControllers();
            this.var_1105.height = Util.getLowestPoint(this.var_1105) + 4;
         }
         else
         {
            this.populateForm();
         ...
         this.var_1364.text = !!this.var_489 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1669.name,this.var_1365.name,this.var_1106.name,this.var_1105.name,this.var_1363.name,this.var_1670.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_716.setText(_loc1_.name);
         this.var_1110.setText(_loc1_.description);
         this.var_889.setText("");
         this.var_1107.setText("");
         ...
         this.setTag(this.var_891,_loc1_.tags[0]);
         this.setTag(this.var_890,_loc1_.tags[1]);
         if(this.var_1102)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1103)
         {
            if(_loc1_.method_2)
            {
               this.var_1103.select();
            }
            else
            {
               this.var_1103.unselect();
            }
         }
         if(this.var_593)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_716.getText();
         ...
         {
            _loc8_ = this.var_889.getText();
            _loc9_ = this.var_1107.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_889.clearErrors();
               this.var_1107.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1102.isSelected;
         _loc2_.allowFoodConsume = this.var_1109.isSelected;
         _loc2_.method_2 = this.var_1103.isSelected;
         _loc2_.hideWalls = this.var_593.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_891,_loc2_.tags);
         this.addTag(this.var_890,_loc2_.tags);
         this.clearErrors();
         this.var_1104 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_133,HabboToolbarIconEnum.ROOMINFO));
      }
