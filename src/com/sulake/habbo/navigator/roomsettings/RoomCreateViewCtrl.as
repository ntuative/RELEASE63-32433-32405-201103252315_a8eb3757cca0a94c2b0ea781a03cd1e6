package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1179:RoomLayout;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1179.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1820 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1820 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_190 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         ...
         var _loc3_:IWindow = this.var_190.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1178 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_190.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_190.desktop,this.var_190.width,this.var_190.height);
         this.var_190.x = _loc4_.x;
         this.var_190.y = _loc4_.y;
      }
      ...
      {
         return IButtonWindow(this.var_190.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_190.findChildByName("back_button"));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent) : void
      {
         ...
         var _loc3_:String = "model_" + this.var_1179.name;
