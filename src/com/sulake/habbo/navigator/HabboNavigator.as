package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1097:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_588 = new RoomInfoViewCtrl(this);
         this.var_1097 = new RoomCreateViewCtrl(this);
         this.var_2188 = new RoomThumbnailRenderer(this);
         this.var_889 = new GuestRoomPasswordInput(this);
         this.var_323 = new GuestRoomDoorbell(this);
         this.var_407 = new Tabs(this);
         this.var_1096 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_314,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_588.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_303.startSearch(Tabs.const_265,Tabs.const_391,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_303.startSearch(Tabs.const_305,Tabs.const_248);
         this.var_407.getTab(Tabs.const_305).tabPageDecorator.tabSelected();
      }
