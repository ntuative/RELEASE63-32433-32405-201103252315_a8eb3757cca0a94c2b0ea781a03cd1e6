package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_429 = new Timer(500,1);
         this.var_362 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1048 = param4;
         this.var_2452 = param2;
         this._popupIndentLeft = param3;
         this.var_429.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_429)
         {
            this.var_429.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_429.reset();
            this.var_429 = null;
         }
         if(this.var_362)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_56 == null)
         {
            this.var_56 = IWindowContainer(this._navigator.getXmlWindow(this.var_1048));
         ...
         this.var_56.x = _loc2_.x + this.var_2452 + param1.width;
