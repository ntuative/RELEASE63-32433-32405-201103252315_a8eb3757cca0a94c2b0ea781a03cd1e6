   ...
   public class RoomPlaneParser
   {
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_169.push(_loc4_);
            _loc3_++;
         }
         this.var_258 = param1;
         this._height = param2;
         this.var_530 = this.var_258;
         this.var_529 = -1;
         this.var_528 = this._height;
         this.var_531 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_258 && param2 >= 0 && param2 < this._height)
         {
            _loc4_ = this.var_169[param2] as Array;
            ...
            {
               if(param1 == this.var_530 || param1 == this.var_529)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_528;
                  while(_loc6_ < this.var_531)
                  {
               ...
               if(param2 == this.var_528 || param2 == this.var_531)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_530;
                  while(_loc8_ < this.var_529)
                  {
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_169[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_169);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_963 = getFloorHeight(this.var_169);
         if(!param1)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_169.length)
         {
            _loc4_ = this.var_169[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_330,param1,param2,param3,[param4]);
         ...
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_170,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_140) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_170,Vector3d.sum(param1,Vector3d.product(param3,-this.var_140 / param3.length)),Vector3d.product(param3,(param3.length + this.var_140) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
      ...
      {
         if(param1 == null || this.var_169 == null || param1 == this.var_169)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_169.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_169[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_193,_loc13_,new Vector3d(0,0,-this.var_140),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_193,_loc13_,new Vector3d(0,0,-this.var_140),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_193,_loc13_,new Vector3d(0,0,-this.var_140),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_193,_loc13_,new Vector3d(0,0,-this.var_140),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_141[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1029;
         }
         var _loc2_:RoomPlaneData = this.var_141[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_141[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
