package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1640:String = "cone";
      
      public static const const_1625:String = "plane";
      
      public static const const_1665:String = "sphere";
      ...
      private var var_955:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_956 = 0;
         this.var_986 = false;
         this.init(0,0,0,this._direction,this.var_2554,this.var_955,this.var_2555,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1180.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_986 = true;
         if(this.var_956 < this.var_1441)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2557)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_955,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1180.length);
         return this.var_1180[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_956 < this.var_1441)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_956 < this.var_1441)
         {
            ...
            this.y = (2 - this.var_254) * this.y - (1 - this.var_254) * this.lastY + this.var_1821 * this.var_955 * this.var_955;
         ...
         for each(_loc2_ in this.var_376)
         {
            ...
            _loc2_.y = (2 - this.var_254) * _loc2_.y - (1 - this.var_254) * _loc2_.lastY + this.var_1821 * this.var_955 * this.var_955;
