   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_141 != null)
         {
            ...
            {
               _loc2_ = this.var_141[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_926);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < this.var_141.length)
         {
            _loc6_ = false;
            ...
            if(_loc8_ == null)
            {
               _loc8_ = new BitmapDataAsset(this._assetLibrary.method_3(BitmapDataAsset));
               this._assetLibrary.setAsset(_loc7_,_loc8_);
            }
            _loc9_ = this.var_141[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1811;
               }
