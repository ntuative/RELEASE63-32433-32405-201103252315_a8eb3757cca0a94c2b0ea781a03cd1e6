package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1424:Number = 30;
      ...
      {
         var _loc4_:* = null;
         this.var_695 += this.var_2780 / const_1424;
      ...
      {
         var _loc3_:Number = this.var_1388 * Math.cos(this.var_695 + this.var_1975);
         var _loc4_:Number = this.var_1388 * Math.sin(this.var_695 + this.var_1975);
