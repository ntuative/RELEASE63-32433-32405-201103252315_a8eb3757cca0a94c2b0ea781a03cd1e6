package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_426:int = 2;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_747[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_747[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_747.length == 2)
            {
               return this.var_747[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_747.length == 2)
            {
               return this.var_747[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1143[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1143.push(Math.random() * _loc2_ * 1.5);
         this.var_1143.push(Math.random() * _loc2_ * 1.5);
         this.var_1144 = new Array();
         this.var_1144.push(1);
         this.var_1144.push(-1);
         this.var_1142 = new Array();
         this.var_1142.push(const_1323);
         this.var_1142.push(const_1322);
