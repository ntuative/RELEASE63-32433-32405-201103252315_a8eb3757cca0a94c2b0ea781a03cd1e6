package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1563:int = 16777215;
      
      public static const const_1611:int = 13421772;
      
      private static const const_971:int = 16777215;
      
      private static const const_968:int = 13421772;
      
      private static const const_970:int = 10066329;
      
      private static const const_969:int = 10066329;
      
      public static const const_1513:int = 16777215;
      
      public static const const_1621:int = 13421772;
      
      public static const const_1543:int = 10066329;
      ...
      private var var_1579:String = null;
      
      private var var_2539:String = null;
      
      private var var_1173:uint = 16777215;
      
      private var var_2538:int = 255;
      
      private var var_2536:int = 255;
      
      private var var_2540:int = 255;
      
      private var var_1812:Boolean = true;
      
      private var var_1811:int = 0;
      
      private var var_1633:int = -1000;
      
      private const const_2052:int = 250;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_141 != null)
         {
            ...
            {
               _loc4_ = this.var_141[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_141.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_141[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1217);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1169);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_193)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1563;
               }
               else
               {
                  _loc13_.color = const_1611;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_170)
            {
               ...
               {
                  _loc13_.color = const_968;
               }
               else
               {
                  _loc13_.color = const_970;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_330)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1513;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1621;
               }
               else
               {
                  _loc13_.color = const_1543;
               }
               if(this._data != null)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_330)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         _loc9_ = param2;
         if(_loc9_ < this.var_1633 + this.const_2052 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_373.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1812)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2540 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2536 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2538 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1586)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1328 || _loc3_.y != this.var_2141 || _loc3_.z != this.var_2145 || param1.scale != this.var_2142))
            {
               this.var_1328 = _loc3_.x;
               this.var_2141 = _loc3_.y;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1097);
            if(_loc3_ != this.var_2539)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2539 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_788));
            if(_loc4_ != this.var_1173)
            {
               this.var_1173 = _loc4_;
               this.var_2540 = this.var_1173 & 255;
               this.var_2536 = this.var_1173 >> 8 & 255;
               this.var_2538 = this.var_1173 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1141));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_176 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_924);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_766);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_836);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_903));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_768));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_839));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_141.length)
         {
            _loc5_ = this.var_141[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1811;
      }
      ...
      private function getPlaneBitmap(param1:RoomPlane, param2:String) : BitmapData
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = new BitmapDataAsset(this._assetLibrary.method_3(BitmapDataAsset));
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_141.length)
         {
            _loc3_ = this.var_141[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_520.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               {
                  _loc3_ = this.var_141[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_273)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_141[_loc18_] as RoomPlane;
