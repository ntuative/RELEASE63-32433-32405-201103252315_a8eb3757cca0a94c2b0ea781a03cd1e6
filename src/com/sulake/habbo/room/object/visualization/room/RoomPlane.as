package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1029:IPlaneRasterizer = null;
      
      private var var_769:PlaneMaskManager = null;
      ...
      private var var_460:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2805 = param10;
         this.var_2804 = param11;
         this.var_2801 = param12;
      ...
      {
         return this._isVisible && this.var_834;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_625);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1029.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_460;
         if(_loc3_ == null)
         {
         ...
         if(this.var_834 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_398))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1029 != null)
            {
               _loc3_ = this.var_1029.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1996,this.var_2803,this.var_2805,this.var_2804,this.var_2801,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_834)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1372.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1372[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1074);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_156.z - originZ,this.var_115.z - originZ,this.var_86.z - originZ,this.var_114.z - originZ);
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2802);
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1030)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_397.length)
            {
               _loc5_ = this.var_397[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_283.length == this.var_1028.length)
         {
            while(_loc1_ < this.var_283.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1028[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_397.length > this.var_1542.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1030 || this.var_283.length == 0 && this.var_397.length == 0 && !this.var_398 || this.var_769 == null)
         {
            return;
         }
         ...
         if(this.var_398)
         {
            ...
            while(_loc5_ < this.var_283.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  this.var_769.updateMask(this.var_72,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1028.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_397.length)
            {
               _loc4_ = this.var_397[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_238.copyChannel(param1,param1.rect,const_625,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_238.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_238,this.var_238.rect,const_625,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
