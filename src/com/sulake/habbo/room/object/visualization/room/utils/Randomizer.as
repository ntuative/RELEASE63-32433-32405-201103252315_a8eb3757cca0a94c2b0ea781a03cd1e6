package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2010:int = 16777216;
      ...
      private var var_2893:int = 69069;
      
      private var var_2894:int = 5;
      ...
      {
         var _loc1_:int = this.var_2893 * this.var_1952 + this.var_2894;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1953;
         this.var_1952 = _loc1_;
         return _loc1_;
      }
