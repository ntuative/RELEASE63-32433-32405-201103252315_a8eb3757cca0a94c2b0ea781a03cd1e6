package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_367:int = 1000;
      
      public static const const_1698:int = 0;
       
      
      private var var_589:int = 0;
      
      private var var_1449:int = 360;
      
      private var var_791:DirectionData = null;
      
      private var var_256:Map;
      
      private var _colors:Map;
      
      private var var_1187:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_791 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_791,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_791);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1202);
                  break;
               case "SUBTRACT":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1449 / 2) % 360 / this.var_1449;
         ...
         {
            _loc6_ = int(this.var_256.getKey(_loc5_)) * this.var_1449;
