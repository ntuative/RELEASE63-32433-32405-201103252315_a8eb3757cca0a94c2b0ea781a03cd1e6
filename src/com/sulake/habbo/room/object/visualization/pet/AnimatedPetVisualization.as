package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1398:String = "head";
      
      private static const const_620:int = 1;
      
      private static const const_997:int = 1000;
      
      private static const const_1399:String = "pet_experience_bubble_png";
      
      private static const const_1396:int = 0;
      
      private static const const_1397:int = 1;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_1002 = [];
         super();
         while(this.var_124.length < ANIMATION_INDEX_COUNT)
         {
            this.var_124.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_124 != null)
         {
            ...
            {
               _loc2_ = this.var_124[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1399) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_392 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_176)
         {
            ...
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_138);
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_138);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1984 = _loc3_.getNumber(RoomObjectVariableEnum.const_401) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_184);
            if(!isNaN(_loc8_))
            {
               this.var_1920 = _loc8_;
            }
            else
            {
               this.var_1920 = direction;
            }
            this.var_1369 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2195 = _loc3_.getNumber(RoomObjectVariableEnum.const_811);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_845);
            if(_loc9_ != this.var_1921)
            {
               this.var_1921 = _loc9_;
               this.var_2722 = this.var_1921.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_392 != null)
         {
            ...
            if(this.var_1369 > 0)
            {
               _loc2_ = param1 - this.var_1369;
               if(_loc2_ < const_997)
               {
                  this.var_392.alpha = int(Math.sin(_loc2_ / const_997 * 0) * 255);
                  this.var_392.setExperience(this.var_2195);
               }
               else
               {
                  this.var_1369 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_392.alpha > 0)
                  {
                     _loc3_.asset = this.var_392.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_392.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_620;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 >= 0 && param1 < this.var_124.length)
         {
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1501 = false;
         var _loc1_:int = this.var_124.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_124[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getFrameNumber(param1:int, param2:int) : int
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:int = this.var_124.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_124[_loc3_];
            if(_loc4_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_124.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_124[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2722);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_620)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_620))
            {
               if(param2 >= FurnitureVisualizationData.const_495.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_495[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1920);
         }
         return direction;
      }
      ...
      {
         if(this.var_1002[param1] == null)
         {
            if(this._animationData.getTag(var_103,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1398)
            {
               this.var_1002[param1] = true;
            }
            else
            {
               this.var_1002[param1] = false;
            }
         }
         return this.var_1002[param1];
      }
   }
}
