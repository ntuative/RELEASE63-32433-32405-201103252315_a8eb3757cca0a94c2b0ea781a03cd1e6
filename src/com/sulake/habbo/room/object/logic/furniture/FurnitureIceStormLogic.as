   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_1188 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1188 > 0 && param1 >= this.var_1188)
         {
            this.var_1188 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1721,String(this.var_1721),this.var_2588);
