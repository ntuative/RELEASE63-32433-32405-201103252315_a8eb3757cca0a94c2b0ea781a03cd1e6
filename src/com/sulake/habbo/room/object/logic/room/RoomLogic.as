package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_2024:int = 255;
      
      private var var_1285:uint = 16777215;
      
      private var var_2022:int = 255;
      
      private var var_1284:int = 0;
      
      private var var_2023:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_568,RoomObjectMouseEvent.const_147];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1217,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_788,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_903,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_768,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_839,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1284)
         {
            ...
            if(_loc2_ - this.var_1284 >= this.var_2023)
            {
               _loc3_ = this.var_1285;
               _loc4_ = this.var_2022;
               this.var_1284 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1285 >> 16 & 255;
               _loc11_ = this.var_1285 >> 8 & 255;
               _loc12_ = this.var_1285 & 255;
               _loc13_ = (_loc2_ - this.var_1284) / this.var_2023;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2024 + (this.var_2022 - this.var_2024) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_788,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_787:
               param2.setString(RoomObjectVariableEnum.const_924,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_753:
               param2.setString(RoomObjectVariableEnum.const_836,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_502:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_273)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_735:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1097,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1078:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1246:
               param2.setNumber(RoomObjectVariableEnum.const_768,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_839,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1141,int(param1.bgOnly));
         this.var_1554 = this._color;
         this.var_2024 = this.var_1947;
         this.var_1285 = _loc3_;
         this.var_2022 = _loc4_;
         this.var_1284 = getTimer();
         this.var_2023 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_479,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1636,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1522,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1732,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_479,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_170 || _loc12_ == RoomPlaneData.const_330)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
