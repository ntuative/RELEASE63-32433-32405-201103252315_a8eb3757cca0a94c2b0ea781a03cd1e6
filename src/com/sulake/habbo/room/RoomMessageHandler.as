package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1456:int = -1.0E9;
      
      private var var_796:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_796 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_796.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_796.objectData);
            this.var_796.objectData = null;
         }
         else
         {
            this.var_796.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_796.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_796.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_883);
         var _loc8_:int = 0;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1137:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1189:
                     _loc10_ = "std";
               }
