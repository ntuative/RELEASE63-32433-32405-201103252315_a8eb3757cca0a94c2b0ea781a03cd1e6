package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_242 = param2;
         this.var_724 = [];
         this.var_724.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_724.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         ...
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_802,this.onSoundMachinePlayEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_742,this.onSoundMachineStopEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_376;
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_312,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_802,this.onSoundMachinePlayEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_742,this.onSoundMachineStopEvent);
               this.var_83 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_527 == param1)
         {
            this.playCurrentSongAndNotify(this.var_527);
      ...
      {
         this.var_242.stop(HabboMusicPrioritiesEnum.const_376);
         this.var_527 = -1;
         this.var_642 = false;
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_242.playSong(param1,HabboMusicPrioritiesEnum.const_376,_loc3_))
         {
      ...
      private function convertParserPlayList(param1:Array) : Array
      {
         ...
         {
            if(this.var_242.getSongInfo(_loc3_.id) == null)
            {
               _loc2_.push(new SongDataEntry(_loc3_.id,_loc3_.length,_loc3_.name,_loc3_.creator,null));
            }
            else
            {
               _loc2_.push(this.var_242.getSongInfo(_loc3_.id) as SongDataEntry);
            }
         }
         return _loc2_;
      }
      ...
      private function onPlayListMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc8_ < _loc5_.length)
         {
            ...
            {
               this.var_527 = _loc6_.id;
               _loc6_.startPlayHeadPos = Number(_loc4_) / 1000;
            }
            _loc4_ -= _loc6_.length;
            _loc8_++;
         }
         this._events.dispatchEvent(new PlayListUpdatedEvent(PlayListUpdatedEvent.const_487));
