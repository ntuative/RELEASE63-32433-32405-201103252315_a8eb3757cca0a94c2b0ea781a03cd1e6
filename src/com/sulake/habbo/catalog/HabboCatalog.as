package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1070:IRoomSession;
      ...
      private var var_292:CatalogViewer;
      ...
      private var var_216:PurchaseConfirmationDialog;
      
      private var var_293:ChargeConfirmationDialog;
      ...
      private var var_2134:GiftWrappingConfiguration;
      
      private var var_1069:ClubGiftController;
      
      private var var_478:ClubBuyController;
      
      private var var_699:Map;
      
      private var var_1071:Boolean = false;
      
      private var var_867:IPurchasableOffer;
      
      private var var_1072:IDragAndDropDoneReceiver;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.method_1 > 0 && param1.method_1 > this.var_106.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_216 == null)
            {
               this.var_216 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_216.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_478.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         return this.var_311.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_311.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_77)
         {
            _loc3_ = this.var_311.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_699.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_106.getActivityPointsForType(Purse.const_183)));
         var _loc1_:int = 0;
      ...
      {
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_150,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_782)
         {
            if(!this.var_311.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_292.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_292 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_292.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_267,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1583 = param1.session.isPrivateRoom;
               this.var_1070 = param1.session;
               if(this.var_91 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1069 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_478 == null)
         {
            this.var_478 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_700 && this.var_700 != "")
         {
            this.var_345.openPage(this.var_700);
            this.var_700 = "";
            this.var_868 = -1;
         }
         else if(this.var_868 > -1)
         {
            this.var_345.openPageById(this.var_868,this.var_1584);
            this.var_868 = -1;
            this.var_1584 = -1;
            this.var_700 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_292.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_292.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2132 && this.var_477 != null)
         {
            this.var_477.playSound(HabboSoundTypesEnum.const_1024);
         }
         this.var_2132 = false;
         if(this.var_293 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2133 && this.var_477 != null)
         {
            this.var_477.playSound(HabboSoundTypesEnum.const_1176);
         }
         this.var_2133 = false;
         if(this.var_293 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1069.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_292.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2134 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_216 != null)
         {
            this.var_216.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_293 == null)
         {
            this.var_293 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_293.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_699.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_699.add(_loc2_.productCode,_loc3_.slice());
            this.var_292.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_1070 || !this.var_1070.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_1071 && param1.type == RoomEngineObjectEvent.const_162)
         {
            this.resetPlacedOfferData();
            if(this.var_867 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_85 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_867);
            if(this.var_1072 != null)
            {
               this.var_1072.onDragAndDropDone(true);
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_867.productContainer.firstProduct;
            ...
            if(_loc4_)
            {
               _loc4_.getModelController().setNumber(RoomObjectVariableEnum.const_326,0.5);
            }
            this.resetObjectMover();
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_85 != null)
         {
            if(this.var_85.category == RoomObjectCategoryEnum.const_28)
            {
               this._roomEngine.disposeObjectFurniture(this.var_85.roomId,this.var_85.roomCategory,this.var_85.objectId);
            }
            else if(this.var_85.category == RoomObjectCategoryEnum.const_26)
            {
