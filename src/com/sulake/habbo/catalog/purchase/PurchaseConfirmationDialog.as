package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2029:int = 10;
      ...
      private const const_1759:uint = 4.293848814E9;
      
      private const const_1758:uint = 4.294967295E9;
      
      private const const_2030:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1591 = _loc1_.stuffTypes;
            this.var_703 = _loc1_.boxTypes;
            this.var_704 = _loc1_.ribbonTypes;
            this.var_1081 = this.var_1591[0];
            this.var_348 = this.var_703[0];
            this.var_346 = this.var_704[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_346 < 0)
         {
            this.var_346 = this.var_704.length - 1;
         }
         if(this.var_346 > this.var_704.length - 1)
         {
            this.var_346 = 0;
         }
         if(this.var_348 < 0)
         {
            this.var_348 = this.var_703.length - 1;
         }
         if(this.var_348 > this.var_703.length - 1)
         {
            this.var_348 = 0;
         }
         var _loc1_:int = this.var_703[this.var_348] * 1000 + this.var_704[this.var_346];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1081,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1332 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1591;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1081);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_703[this.var_348]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_704[this.var_346]);
         this._catalog.purchaseProductAsGift(this.var_1331,this.var_92,this.var_1330,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1331,this.var_92.offerId,this.var_1330);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_105:
               ...
               for each(_loc7_ in this.var_221)
               {
                  ...
                  if(_loc5_.length >= this.const_2029)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2148 = _loc3_.text;
               break;
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN:
               ...
               break;
            case WindowKeyboardEvent.const_410:
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_463:
               this.showSelectors(false);
               break;
            case WindowEvent.const_820:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_244 == null || this.var_577 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2030;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1759) : uint(this.const_1758);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1081;
               }
            }
            _loc4_++;
         }
