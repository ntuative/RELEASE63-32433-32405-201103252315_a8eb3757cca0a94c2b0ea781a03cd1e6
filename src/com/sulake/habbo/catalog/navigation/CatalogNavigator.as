package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2927:String = "magic.credits";
      
      private var var_2889:String = "magic.pixels";
      
      private var var_2888:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2889);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2888,true);
      }
