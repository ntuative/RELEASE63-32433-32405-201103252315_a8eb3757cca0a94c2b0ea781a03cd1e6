package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1745:String = "ctlg_";
       
      
      protected var var_2078:XML;
      ...
      private var var_507:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1163:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_507 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1164);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1164);
      }
      ...
      {
         var _loc2_:String = const_1745 + param1;
         ...
         this.var_2078 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2078) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1680:
               if(this.var_1163 == null)
               {
                  this.var_1163 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1163);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1654:
               ...
               break;
            case CatalogWidgetEnum.const_1464:
               this.var_48.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1504:
            ...
            case CatalogWidgetEnum.const_1612:
               ...
               break;
            case CatalogWidgetEnum.const_1510:
            ...
            case CatalogWidgetEnum.const_1631:
               ...
               break;
            case CatalogWidgetEnum.const_1485:
            ...
            case CatalogWidgetEnum.const_1660:
               ...
               break;
            case CatalogWidgetEnum.const_1682:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_507.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_507 != null)
         {
            return this.var_507.dispatchEvent(param1);
         }
         return false;
      }
   }
