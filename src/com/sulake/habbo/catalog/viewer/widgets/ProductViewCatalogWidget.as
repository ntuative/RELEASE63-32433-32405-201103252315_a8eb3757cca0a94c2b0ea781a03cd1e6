package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_994:ITextWindow;
      ...
      private var var_1488:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_994 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1231 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1905 = new Point(this.var_89.x,this.var_89.y);
         this.var_542 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1488 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1904 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_994.text = _loc4_;
         this.var_1231.text = _loc5_;
         this.var_994.height = this.var_994.textHeight + 5;
         this.var_1231.y = this.var_994.y + this.var_994.height;
         this.var_1231.height = Math.max(130,this.var_1231.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_520:
                  _loc6_ = this.var_1904.clone();
                  if(this.var_542 != null)
                  {
                     this.var_542.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_542,this.var_1488,this.var_1612);
                     this.var_542.scrollV = 0;
                  }
                  break;
               case Offer.const_570:
                     ...
                     case ProductTypeEnum.const_174:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_295,AvatarAction.const_529);
                              _loc16_.appendAction(AvatarAction.const_320,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2692)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2692 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_89 != null && true)
         {
            ...
            this.var_89.x = this.var_1905.x;
            this.var_89.y = this.var_1905.y;
            if(param3 != null)
            {
