package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1269:int = 18;
      ...
      private var var_206:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_474 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_474 < 8)
         {
            return false;
         }
         this.var_2109 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_206 != null && this.var_206.length > 0)
         {
            this.var_341 = this.var_206[0];
         }
         else
         {
            this.var_341 = -1;
         }
         this._offers.add(this.var_474,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_206 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1269 && _loc2_ < this.var_206.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_474,this.var_206[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_206 != null && this.var_206.length > 0)
         {
            ...
            this.var_341 = this.var_206[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_474,this.var_341),this.getRaceLocalizationKey(this.var_474,this.var_341));
            }
         }
         return this.getRaceLocalizationKey(this.var_474,this.var_341);
      }
