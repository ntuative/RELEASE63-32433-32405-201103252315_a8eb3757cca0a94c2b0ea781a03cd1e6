package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_941.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_941 = null;
         }
         if(this.var_942 != null)
         {
            this.var_942.removeEventListener(WindowKeyboardEvent.const_204,this.windowKeyEventProcessor);
            this.var_942 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_941 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_941 != null)
         {
            this.var_941.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_942 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_942 != null)
         {
            this.var_942.addEventListener(WindowKeyboardEvent.const_204,this.windowKeyEventProcessor);
         }
         return true;
      }
