package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1014:int = 2;
      ...
      {
         return this.var_682 != const_1015;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1987 != RecyclerStatusMessageEvent.const_1061;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_682 == const_430;
      }
      ...
      {
         this.var_682 = const_1014;
         this.var_126 = new Array(const_177);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1714:
               this.var_682 = const_430;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1061:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1040:
               if(this.var_17 != null)
               {
                  this.var_17.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1664:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_126[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_177)
            {
               oldObjectData = this.var_126[newSlotId];
         ...
         this.var_126[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_126[param1].id))
         {
            return;
         }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_126.length < const_177)
         {
            return false;
         }
         var _loc1_:int = 0;
