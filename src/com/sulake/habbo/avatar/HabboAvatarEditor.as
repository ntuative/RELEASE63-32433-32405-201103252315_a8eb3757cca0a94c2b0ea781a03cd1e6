package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1365:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1215:AvatarEditorHandler;
      ...
      private var var_984:IFigureData;
      ...
      {
         this.var_1021 = FigureData.const_76;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_197)
         {
            ...
            _loc2_.loadAvatarData(const_1364,FigureData.const_76);
            _loc3_.loadAvatarData(const_1365,FigureData.FEMALE);
            this.var_104 = new Map();
            this.var_532 = new Map();
            this.var_104.add(AvatarEditorFigureCategory.const_719,new BodyModel(this));
            this.var_104.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_104.add(AvatarEditorFigureCategory.const_221,new TorsoModel(this));
            this.var_104.add(AvatarEditorFigureCategory.const_728,new LegsModel(this));
            ...
            this.var_532.add(AvatarEditorSideCategory.const_106,new WardrobeModel(this));
            this.var_532.add(AvatarEditorSideCategory.const_456,new ClubPromoModel(this));
            this.var_197 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_984.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_984.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_264 == null)
            {
               this.var_264 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_264.addChild(this.var_17.window);
               if(param5)
               {
                  this.var_264.center();
               }
            ...
            this.var_264.visible = !this.var_264.visible;
         }
         this.var_17.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_719);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_532.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_533 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_984 = this.var_533.getFigureData(AvatarType.const_113);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1215 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_643[this.var_1021];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1885;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1214 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1363)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1557.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_533.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_533.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1292.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1723)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1214 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1292.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1214 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_532.getValue(AvatarEditorSideCategory.const_106);
      }
