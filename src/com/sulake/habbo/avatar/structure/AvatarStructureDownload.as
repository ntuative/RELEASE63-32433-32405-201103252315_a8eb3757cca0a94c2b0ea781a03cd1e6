package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1117:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2282:IStructureData;
      
      private var var_1642:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1642 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2282.appendXML(this.var_1642);
         dispatchEvent(new Event(AvatarStructureDownload.const_1117));
      }
   }
}
