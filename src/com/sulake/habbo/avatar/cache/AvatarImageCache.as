package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1763:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1448:IAvatarImage;
      ...
      private var var_357:IActiveActionData;
      
      private var var_432:AvatarImageBodyPartContainer;
      
      private var var_1374:String;
      
      private var var_119:AvatarImagePartContainer;
      
      private var var_2359:Point;
      ...
      private var var_2357:ByteArray;
      
      private var var_2358:ImageData;
      
      private var var_859:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_722 == GeometryType.const_1092 && param1 == GeometryType.const_1178 || this.var_722 == GeometryType.const_1178 && param1 == GeometryType.const_1092)
         {
            this.var_722 = param1;
            this.var_88 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_357 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_357;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_357 || !this.var_357.definition))
         {
            if(this.var_357.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_357.definition.state + "." + this.var_357.actionParameter);
               _loc13_ = param2 - this.var_357.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_357.overridingAction);
                  if(_loc14_ != null)
                  {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1448.getFigure(),_loc5_,this.var_722,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_432 = _loc10_.getImageContainer(_loc4_);
         if(this.var_432 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_432 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_357);
            if(this.var_432 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_432,_loc4_);
         }
         this.var_432.offset = _loc8_;
         return this.var_432;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_88)
         {
            this.var_88 = this._structure.getCanvas(this._scale,this.var_722);
            if(!this.var_88)
            {
               return null;
            }
            this.var_2359 = new Point(0,this.var_88.height - int(this.var_88.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1676[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_844 || _loc10_ == AvatarAction.const_414;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1374 = this.var_119.bodyPartId;
               this.var_184 = this.var_119.partType;
               this.var_1682 = this.var_119.partId;
               ...
               this.var_1375 = this._scale + "_" + this.var_119.action.assetPartDefinition + "_" + this.var_184 + "_" + this.var_1682 + "_" + _loc5_ + "_" + this._frame;
               this.var_418 = this._assets.getAssetByName(this.var_1375) as BitmapDataAsset;
               if(this.var_418 == null)
               {
                  this.var_1375 = this._scale + "_std_" + this.var_184 + "_" + this.var_1682 + "_" + _loc5_ + "_0";
                  this.var_418 = this._assets.getAssetByName(this.var_1375) as BitmapDataAsset;
               }
               if(!(!this.var_418 || !this.var_418.content))
               {
                  if(this.var_119.paletteMapId > -1)
                  {
                     this.var_859 = this._structure.renderManager.paletteManager.getPalette(this.var_119.paletteMapId);
                     if(this.var_859 != null)
                     {
                        this.var_899 = this.var_418.content as BitmapData;
                        this.var_183 = new BitmapData(this.var_899.width,this.var_899.height);
                        this.var_2357 = this.var_859.colorize(this.var_899.getPixels(this.var_899.rect));
                        this.var_183.setPixels(this.var_183.rect,this.var_2357);
                     }
                     else
                     {
                        this.var_183 = (this.var_418.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1374 == AvatarBodyPartType.const_221 || this.var_1374 == AvatarBodyPartType.const_1511 || this.var_1374 == AvatarBodyPartType.const_1453) && this.var_119.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_119.color.colorTransform);
                  }
                  if(this.var_119.isBlendable)
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_119.method_8);
                  }
                  this.var_900 = this.var_418.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_52)
                     {
                  ...
                  this.var_2358 = new ImageData(this.var_183,this.var_900,_loc7_);
                  this.var_898.push(this.var_2358);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2359.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_52)
            {
