package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_676:AvatarFigureContainer;
      
      private var var_605:Boolean;
      
      private var var_202:Array;
      
      private var var_561:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_676 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_676.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1509 = this.var_1210;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_606);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_676,_loc13_,"pet",_loc12_.getDirection(),[]);
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_606);
                  _loc20_ = this.var_90;
                  _loc21_ = 1;
                  switch(this.var_90)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_606);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_676,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_89)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_606);
                  _loc21_ = this.var_90;
                  _loc22_ = 1;
                  switch(this.var_90)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_496 = this.var_496 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1009);
         this.getCache().resetBodyPartCache(this.var_1009);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1510 = this._structure.sortActions(this.var_336);
         ...
         {
            this.var_719 = this._structure.getCanvasOffsets(this.var_1510,this._scale,this.var_90);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1210 = _loc4_.id;
                     this.var_1841 = _loc4_.breed;
                     break;
                  }
               }
            }
