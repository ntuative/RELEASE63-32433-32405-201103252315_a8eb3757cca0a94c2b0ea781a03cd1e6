package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1321:String = "Default";
      
      private static const const_1320:int = 2;
      
      private static const const_1319:String = AvatarSetType.const_36;
      ...
      protected var var_790:Boolean;
      
      protected var var_719:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_248:AvatarImageCache;
      
      protected var var_676:AvatarFigureContainer;
      
      protected var var_561:IAvatarDataContainer;
      
      protected var var_336:Array;
      
      protected var var_46:BitmapData;
      
      private var var_1009:IActiveActionData;
      ...
      private var var_2425:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1319,const_1320);
         this.var_336 = new Array();
         this.var_1009 = new ActiveActionData(AvatarAction.const_361);
         this.var_1009.definition = this._structure.getActionDefinition(const_1321);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_676,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1728;
         if(param2 < AvatarDirectionAngle.const_1087)
         {
            param2 = AvatarDirectionAngle.const_297 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_297)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_606,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_251.length == 1 && this.var_90 == this.var_1920)
         {
            return this.var_90 + this.var_496 + this.var_606 % 4;
         }
         if(this.var_251.length == 2)
         {
            for each(_loc1_ in this.var_251)
            {
               ...
               {
                  return this.var_90 + this.var_496 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_606 % 11;
                  return this.var_90 + "_" + this.var_1920 + this.var_496 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2426 || param2 != this.var_2424 || param1 != this.var_2425)
         {
            this.var_2426 = param3;
            this.var_2424 = param2;
            this.var_2425 = param1;
            this.var_1727 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1295 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1295)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_286.definition.geometryType,this.var_90);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_606);
         ...
         {
            if(this.var_561.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_561.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_286.definition.geometryType,this.var_90);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_606);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_336.push(new ActiveActionData(param1,param2,this.var_606));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_286 = this.var_1009;
         this.var_286.definition = this.var_1009.definition;
         this.resetBodyPartCache(this.var_1009);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_496 = "";
         this.var_251 = this._structure.sortActions(this.var_336);
         if(this.var_251 == null)
         {
            this.var_719 = new Array(0,0,0);
            if(this.var_1401 != "")
            {
               _loc1_ = true;
               this.var_1401 = "";
         ...
         {
            this.var_719 = this._structure.getCanvasOffsets(this.var_251,this._scale,this.var_90);
            for each(_loc4_ in this.var_251)
            {
               this.var_496 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_320)
               {
            ...
            if(this.var_1401 != this.var_496)
            {
               _loc1_ = true;
               this.var_1401 = this.var_496;
            }
         }
         this.var_1402 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_251)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_971 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1728 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_561 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_317 || _loc1_.actionType == AvatarAction.const_230 || _loc1_.actionType == AvatarAction.const_414)
               {
                  this.var_971 = true;
               }
            }
