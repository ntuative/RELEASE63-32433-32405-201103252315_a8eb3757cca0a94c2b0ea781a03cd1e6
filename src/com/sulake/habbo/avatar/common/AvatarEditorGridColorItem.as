package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_569.width,this.var_569.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_569,this.var_569.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_863.width,this.var_863.height,true,0);
            _loc5_ = this.var_863.clone();
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_862.width,this.var_862.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_862,this.var_862.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
