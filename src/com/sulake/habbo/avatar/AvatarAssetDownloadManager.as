package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_1019:int = 3;
      
      private var var_458:AssetLoaderStruct;
      
      private var var_1020:Timer;
      ...
      private const const_2078:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_1020 = new Timer(this.const_2078,1);
         this.var_1020.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_1019);
            if(this.var_1529.indexOf("?") > 0)
            {
               _loc2_ = this.var_1529 + "&retry=" + this.var_1019;
            }
            else
            {
               _loc2_ = this.var_1529 + "?retry=" + this.var_1019;
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2778,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1973)
         {
            this.var_1260.push([param1,param2]);
            return;
         }
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_1018)
         {
            _loc7_ = true;
            _loc4_ = this.var_1018[_loc3_];
      ...
      {
         var _loc1_:* = null;
         while(this.var_828.length > 0 && this.var_827.length < this.const_1561)
         {
            _loc1_ = this.var_828[0];
            _loc1_.startDownloading();
            this.var_827.push(this.var_828.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_828.indexOf(param1) == -1 && this.var_827.indexOf(param1) == -1)
         {
