package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1755:Number = 1.0;
      
      private var var_1756:Number = 1.0;
      
      private var var_1754:Number = 1.0;
      ...
      {
         super();
         this.var_1655 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2298 = parseInt(_loc2_,16);
         this.var_2299 = parseInt(_loc3_,16);
         ...
         this.var_988 = new ColorTransform(this.var_1755,this.var_1756,this.var_1754,this._alphaMultiplier);
         this.var_1099 = this.generatePaletteMapForGrayscale(this.var_2299,this.var_2298);
      }
