   ...
   public class MessengerView implements IDisposable
   {
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_16 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_139.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MESSENGER,this.var_16));
         }
         else
         {
            this.refresh();
      ...
      private function prepareContent() : void
      {
         ...
         this.var_982 = new ConversationsTabView(this.var_139,this.var_16);
         this.var_982.refresh();
         this.var_981 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_981.addEventListener(WindowKeyboardEvent.const_204,this.onMessageInput);
         this.var_1472 = new ConversationView(this.var_139,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_809,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1149,true);
      }
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         {
            _loc4_ = 120;
            _loc5_ = this.var_981.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_981.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_981.text = "";
         this.var_139.conversations.addMessageAndUpdateView(new Message(Message.const_901,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
