package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_129,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_129,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_640.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_640.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_206);
         _loc1_.push(RoomWidgetFurniActionMessage.const_450);
         _loc1_.push(RoomWidgetFurniActionMessage.const_563);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_784);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_923);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_875);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1537);
         _loc1_.push(RoomWidgetPetCommandMessage.const_446);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_669);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_505)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_348 || param1.type == RoomWidgetUserActionMessage.const_584 || param1.type == RoomWidgetUserActionMessage.const_592)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_348:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_784:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_923:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_875:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_309);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_478) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_478);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_290);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1045);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1038);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_754)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_462);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_114)
               {
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_137)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_747);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1104;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1125;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1626);
               }
               else
               {
               ...
               _loc21_ = _loc13_.sex;
               _loc22_ = this._container.avatarRenderManager.createAvatarImage(_loc20_,AvatarScaleType.const_52,_loc21_);
               if(_loc22_ != null)
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_640.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_640.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
