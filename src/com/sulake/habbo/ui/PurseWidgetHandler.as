package com.sulake.habbo.ui
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_743);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_413);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_743:
               ...
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_103,_loc2_.getActivityPointsForType(Purse.const_183)));
               break;
            case RoomWidgetOpenCatalogMessage.const_413:
               _loc3_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._container.catalog != null)
               {
                  switch(_loc3_.pageKey)
                  {
                     case RoomWidgetOpenCatalogMessage.const_1157:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1552);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1236:
