package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_843:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_865,RoomWidgetChatSelectAvatarMessage.const_738];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_865:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1106))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1106))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_738:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(this.var_686.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_686.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1287 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1287);
            }
            if(this.var_843 == null)
            {
               ...
               this.var_557.y = 0;
               this.var_557.z = 0;
               this.var_843 = _loc4_.getScreenPoint(this.var_557);
               this.var_1287 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_557.x = 0;
            this.var_557.y = 0;
            this.var_557.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_557);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_843.x || _loc8_.y != this.var_843.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_843,_loc5_));
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_686.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_2030.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_2030.remove(param1);
         if(_loc3_ != null)
         {
