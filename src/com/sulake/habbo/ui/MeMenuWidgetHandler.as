   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_296,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_786,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_649,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_525,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_296,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_786,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_649,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_525,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1425)
            {
               _loc3_ = this._container.sessionDataManager.gender;
               _loc4_ = this._container.avatarRenderManager.createAvatarImage(_loc2_,AvatarScaleType.const_52,_loc3_,this);
               if(_loc4_ != null)
               {
         ...
         if(this.var_180 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1154,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_893);
         _loc1_.push(RoomWidgetDanceMessage.const_740);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_846);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_861);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_808);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_699);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_666);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_413);
         _loc1_.push(RoomWidgetStopEffectMessage.const_696);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1647);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1059);
         _loc1_.push(RoomWidgetToolbarMessage.const_886);
         _loc1_.push(RoomWidgetToolbarMessage.const_683);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_362);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1597);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1133);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_673);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_914);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_767);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1628);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_882);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_647);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_856);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_914:
               ...
               break;
            case RoomWidgetWaveMessage.const_893:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_740:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_846:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_861:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_808:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_413:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1101)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_666:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_699:
            case RoomWidgetStopEffectMessage.const_696:
            ...
            case RoomWidgetSetToolbarIconMessage.const_1148:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1658:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1059:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_673:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_886:
               ...
               break;
            case RoomWidgetToolbarMessage.const_683:
               ...
               {
                  this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_518,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_362:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_494));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_767:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_882:
            ...
            case RoomWidgetStoreSettingsMessage.const_647:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_380,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_856:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_513));
               }
               break;
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_525:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_480));
         }
      }
