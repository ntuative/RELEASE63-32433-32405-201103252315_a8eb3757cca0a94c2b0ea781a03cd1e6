package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_892,RoomWidgetViralFurniMessage.const_798,RoomWidgetViralFurniMessage.const_172];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_892:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_453);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_798:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_497,RoomSessionViralFurniStatusEvent.const_524];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_497:
