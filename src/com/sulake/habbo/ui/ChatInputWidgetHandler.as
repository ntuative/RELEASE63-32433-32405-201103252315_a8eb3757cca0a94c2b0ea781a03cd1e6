package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_688);
         _loc1_.push(RoomWidgetChatTypingMessage.const_791);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_688:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_791:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1052,HabboToolbarIconEnum.CHATINPUT,param1));
      }
