package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_473:int = 4;
      ...
      private static const const_429:Number = 50;
      ...
      private var var_2636:Map;
      
      private var var_454:Map;
      
      private var var_1241:uint;
      
      private var var_1242:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1918 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1918 = 15;
         }
         this.var_1916 = this._window.height;
         this.var_816 = 4;
         this.var_815 = 0;
         this._state = name_2;
         this.var_180 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_598:
               ...
               _loc2_ = Number(this.var_1241) / Number(this.var_454["time_fade_in"]);
               if(this.var_1241 > int(this.var_454["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_994:
               ...
               if(this.var_1499 > int(this.var_454["time_display"]) && !this.var_1917)
               {
                  this.startFadeOut();
               }
               break;
            case const_993:
               ...
               _loc3_ = 1 - Number(this.var_1242) / Number(this.var_454["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1242 > int(this.var_454["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1918;
         if(this._window.height < this.var_1916)
         {
            this._window.height = this.var_1916;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_180.orientation == "TOP" ? int(const_429) : 0;
         var _loc4_:int = this.var_180.orientation == "BOTTOM" ? int(_loc2_.height - const_429) : int(_loc2_.height);
         var _loc5_:int = this.var_180.orientation == "LEFT" ? int(const_429) : 0;
         var _loc6_:int = this.var_180.orientation == "RIGHT" ? int(_loc2_.width - const_429) : int(_loc2_.width);
         if(this.var_454["position_horizontal_follow_toolbar"] == "true" && (this.var_180.orientation != "TOP" && this.var_180.orientation != "BOTTOM"))
         {
            if(this.var_180.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_473;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_473;
            }
         }
         ...
         if(this.var_454["position_vertical_follow_toolbar"] == "true" && (this.var_180.orientation != "RIGHT" && this.var_180.orientation != "LEFT"))
         {
            if(this.var_180.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_816;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_816;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_815;
      }
   }
}
