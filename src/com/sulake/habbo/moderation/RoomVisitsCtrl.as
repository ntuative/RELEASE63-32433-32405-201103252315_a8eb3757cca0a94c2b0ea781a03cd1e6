package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_948:Array = [];
      
      private static var var_1799:int = 200;
      ...
      {
         this.var_771 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_948.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_771.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_948.length < var_1799)
         {
            ...
            param1.width = this.var_771.width;
            param1.height = this.var_771.height;
            var_948.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1433)
         {
