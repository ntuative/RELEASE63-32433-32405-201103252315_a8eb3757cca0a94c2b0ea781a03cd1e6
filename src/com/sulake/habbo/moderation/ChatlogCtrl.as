package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_947:Array = [];
      
      private static var var_1796:int = 1000;
      
      private static var var_946:Array = [];
      
      private static var var_1795:int = 200;
      ...
      private var var_1797:IMessageComposer;
      ...
      {
         this.var_767 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_768 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_513 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1797);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_947.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_946.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_767.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_946.length < var_1795)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_767.width;
            param1.height = this.var_767.height;
            var_946.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1794[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1429.getValue(param2.chatterName))
            {
               this.var_1429.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1429.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1431)
         {
