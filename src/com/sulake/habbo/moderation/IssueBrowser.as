package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1822:IIssueBrowserView;
      
      private var var_1823:IIssueBrowserView;
      
      private var var_1824:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_255 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_255.numTabItems)
            {
               _loc5_ = this.var_255.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_61,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_255 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_255 == null || this.var_255.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_255.selector.getSelectableByName("open_issues");
         this.var_255.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_377.view.width = this.var_255.container.width;
         this.var_377.view.height = this.var_255.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2053:
               ...
               {
                  this.var_1822 = new MyIssuesView(this.issueManager,this,this.var_255.container);
               }
               return this.var_1822;
            case this.const_2054:
               if(this.var_1823 == null)
               {
                  this.var_1823 = new OpenIssuesView(this.issueManager,this,this.var_255.container);
               }
               return this.var_1823;
            case this.const_2055:
               if(this.var_1824 == null)
               {
                  this.var_1824 = new PickedIssuesView(this.issueManager,this,this.var_255.container);
               }
