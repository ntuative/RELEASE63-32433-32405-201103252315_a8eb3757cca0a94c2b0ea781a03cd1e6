package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1490:ICheckBoxWindow;
      
      private var var_1491:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_351));
         Logger.log("BEGINNING TO SHOW: " + this.var_351);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1695;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1490 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1491 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_668,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1573,_loc2_,this.var_543.text,"",""));
         if(this.var_1490.isSelected || this.var_1491.isSelected || this.var_995.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1490.isSelected,this.var_1491.isSelected,this.var_995.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1518);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1448);
      }
