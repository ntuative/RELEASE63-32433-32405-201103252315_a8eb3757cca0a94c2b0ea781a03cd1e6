package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_795:IssueMessageData = null;
      
      private var var_794:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2596 = param2.pickerUserId;
         this.var_2595 = param2.pickerUserName;
         this.var_1455 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1196 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1195;
         }
         if(this.var_795 == null || param1.timeStamp < this.var_795.timeStamp)
         {
            this.var_795 = param1;
         }
         if(this.var_794 == null || param1.priority > this.var_794.timeStamp)
         {
            this.var_794 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1196 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1195;
            }
            if(this.var_795 == _loc2_)
            {
               this.var_795 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_794;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_795;
         if(_loc2_ == null)
         {
