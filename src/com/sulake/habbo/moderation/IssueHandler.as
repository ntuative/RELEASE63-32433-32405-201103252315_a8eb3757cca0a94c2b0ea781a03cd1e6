package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         this.var_535 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         this.var_1222 = new UserInfoCtrl(this._window,this.var_67,_loc3_.message);
         ...
         {
            this.var_1222.load(_loc4_,this.var_172.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_67 != null && this.var_67.issueManager != null && this.var_172 != null)
         {
            this.var_67.issueManager.removeHandler(this.var_172.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_172.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_172.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.closeBundle(this.var_172.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.issueManager.releaseBundle(this.var_172.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_67.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_67,WindowTracker.const_1233,_loc2_),this._window,false,false,true);
      }
