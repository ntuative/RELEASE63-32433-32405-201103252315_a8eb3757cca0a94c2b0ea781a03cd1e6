package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_500:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_152.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_135,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1749,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1749,"/");
         ...
         {
            dispatchEvent(new Event(const_500));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_130.removeEventListener(SSOTicket.const_373,this.onParsedTicketSuccess);
            this.var_130.removeEventListener(SSOTicket.const_333,this.onParsedTicketFailure);
            this.var_130 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_130 = new SSOTicket(this.var_152.assets,_loc3_,_loc2_,param1);
         this.var_130.addEventListener(SSOTicket.const_373,this.onParsedTicketSuccess);
         this.var_130.addEventListener(SSOTicket.const_333,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_152.flashClientUrl = this.var_130.flashClientUrl;
         this.var_152.ssoTicket = this.var_130.ticket;
         this.var_130.removeEventListener(SSOTicket.const_373,this.onParsedTicketSuccess);
         this.var_130.removeEventListener(SSOTicket.const_333,this.onParsedTicketFailure);
         this.var_130 = null;
         dispatchEvent(new Event(const_500));
