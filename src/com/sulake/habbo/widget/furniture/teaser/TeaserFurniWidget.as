package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1768:int = 0;
      ...
      private const const_1771:int = 4;
      
      private const const_2045:int = 0;
      
      private const const_2039:int = 1;
      
      private const const_2037:int = 2;
      
      private const const_2038:int = 3;
      
      private const const_2041:int = 4;
      
      private const const_2044:int = 5;
      
      private const const_1767:String = "deco_img";
      
      private const const_1772:String = "dialog_bg";
      
      private const const_2040:String = "%campaign%_dialog_bg.png";
      
      private const const_338:String = "%campaign%_gift_package.png";
      
      private const const_2042:String = "%campaign%_gift_content.png";
      
      private const const_2043:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1406 = this.var_173.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1406 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1404.length)
         {
            _loc2_ = this.var_1404.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_173 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_453,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_453,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_453:
               _loc2_ = this.const_1768;
               this._shareId = null;
               break;
         ...
         if(this._window && (this.var_1407 != _loc2_ || _loc3_ != this.var_186))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1407)
            {
               ...
               case this.const_1770:
                  ...
                  else if(this.var_402 == this.const_2039)
                  {
                     ...
                     _loc2_ = this.const_2042;
                  }
                  else if(this.var_402 == this.const_2037)
                  {
                  ...
                  else if(this.var_402 == this.const_2038)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_402 == this.const_2041)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_186,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_402 == this.const_2044)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2040.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc5_,this.const_1772);
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_798);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         var _loc4_:String = this.var_173.getKey("viral.furni.post_type","feed");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1405 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1405 == 1 ? "null" : InventoryCategory.const_131);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_685,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1404.push(new ImageDownloader(this,_assets,this.var_186,this.var_1406,param1,param2));
            return;
         }
