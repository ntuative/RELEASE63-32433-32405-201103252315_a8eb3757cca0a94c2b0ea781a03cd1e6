package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_619:String = "welcome_gift_email_unverified";
      
      private const const_990:String = "welcome_gift_email_verified";
      
      private const const_1387:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1227)
         {
            this.setViewState(this.const_990);
         }
         else
         {
            this.setViewState(this.const_619);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_619:
               ...
               this.var_17.findChildByName("edit_text").visible = this.var_1901;
               this.var_17.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_1901);
               break;
            case this.const_990:
      ...
      {
         this.setViewState(this.const_1387);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_910,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1227 ? this.const_990 : this.const_619);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_17.findChildByName("cancel_email_change").setParamFlag(WindowParam.const_30,false);
         this.setButtonState("save_email",false);
         _loc2_.editable = false;
         _loc2_.selectable = false;
         this.var_1483 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1483));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_527,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_785,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_527,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_785,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_527:
               this.var_1484 = param1.email;
               this.var_1227 = param1.isVerified;
               this.var_1901 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1483);
