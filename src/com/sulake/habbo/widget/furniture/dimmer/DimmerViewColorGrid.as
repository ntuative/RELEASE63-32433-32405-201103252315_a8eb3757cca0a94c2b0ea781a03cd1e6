package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_508.numGridItems)
         {
            return;
         }
         this.select(this.var_508.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this.var_17 == null || this.var_508 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1793) as IWindowContainer;
            ...
            _loc3_.width = this.var_619.width;
            _loc3_.height = this.var_619.height;
            this.var_508.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_619.width,this.var_619.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_619,this.var_619.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_945.width,this.var_945.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_945,this.var_945.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_508.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1793 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_619 = BitmapData(_loc3_.content);
         ...
         this.var_945 = BitmapData(_loc3_.content);
      }
