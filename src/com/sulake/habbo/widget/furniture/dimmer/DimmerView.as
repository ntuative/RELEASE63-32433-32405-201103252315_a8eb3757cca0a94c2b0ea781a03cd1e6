package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_62,HabboWindowStyle.const_32,0 | 0,new Rectangle(const_1268,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         this.var_255 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_255.numTabItems)
         {
            _loc6_ = this.var_255.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1524 = _loc2_.light;
         if(this.var_457 != null)
         {
            this.var_457.setValue(this.var_1524);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_255.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_255.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_255.selector.getSelected();
         return this.var_255.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1525 = XML(_loc1_.content);
         return this.var_1525;
      }
