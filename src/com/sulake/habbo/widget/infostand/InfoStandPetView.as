package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2060:int = 152;
      
      private const const_2068:int = 16;
      
      private const const_1355:int = 4;
      
      private const const_2066:uint = 14342874;
      
      private const const_2059:uint = 3815994;
      
      private const const_2065:uint = 2085362;
      
      private const const_2069:uint = 39616;
      
      private const const_2064:uint = 10513106;
      
      private const const_2070:uint = 8734654;
      
      private const const_2062:uint = 9094430;
      
      private const const_2067:uint = 6200576;
      
      private const const_2063:String = "happiness";
      
      private const const_2061:String = "experience";
      
      private const const_2058:String = "energy";
      ...
      {
         if(this.var_54 == null || this.var_208 == null || this.var_69 == null)
         {
            return;
         }
         ...
         this.var_208.height = this.var_54.height + 20;
         this._window.width = Math.max(this.var_208.width,this.var_69.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_208.width < this.var_69.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2063,param1.nutrition,param1.nutritionMax,this.const_2069,this.const_2065);
         this.updateStateElement(this.const_2061,param1.experience,param1.experienceMax,this.const_2070,this.const_2064);
         this.updateStateElement(this.const_2058,param1.energy,param1.energyMax,this.const_2067,this.const_2062);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2060,this.const_2068,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2066);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2059);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1355,_loc7_.width - 2,_loc7_.height - 2 - this.const_1355);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1355);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_556) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_54 = this.var_208.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_208.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_208.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_208.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_209 && this.var_209.getPetId() == this.var_556)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1523,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_472,this._widget.petData.ownerId);
