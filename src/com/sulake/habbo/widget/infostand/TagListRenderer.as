package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2047:int = 5;
      
      private const const_2048:int = 5;
      ...
      private var var_1150:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1151 = 0;
         this.var_1150 = param2.rectangle.clone();
         this.var_1150.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1150.width)
         {
            return false;
         }
         if(this.var_1151 + param1.height > this.var_1150.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1150.width)
         {
            this._offsetX = 0;
            this.var_1151 += param1.height + this.const_2048;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1151);
         this._offsetX += param1.width + this.const_2047;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1409 != null && this.var_1409.indexOf(param1) != -1)
         {
