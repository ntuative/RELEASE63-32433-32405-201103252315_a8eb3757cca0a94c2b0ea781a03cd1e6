package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_974:int = 35;
      
      private static const const_427:String = "name";
      
      private static const const_975:String = "message";
      
      private static const const_1350:String = "pointer";
      
      private static const const_5:String = "background";
      
      private static var var_383:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_447)
         {
            var_447 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
         ...
         if(!var_383)
         {
            var_383 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_383.tags.push("roomchat_bubble");
            var_383.x = 0;
            var_383.y = 0;
            var_383.width = 0;
            var_383.background = true;
            var_383.mouseThreshold = 0;
            var_228.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
      }
      ...
      {
         this.var_1460 = param1.chatType;
         this.var_1199 = param1.userId;
         this.var_965 = param1.userName;
         this.var_1198 = param1.userCategory;
         this._message = param1.text;
         this.var_384 = param1.links;
         this.var_1867 = param1.userX;
         this.var_257 = param1.userImage;
         this.var_2616 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_165,this.width,const_976);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1460)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_279:
               this._window = var_383.clone() as IRegionWindow;
               isRespect = true;
               break;
         ...
         var textWindow:ITextWindow = this._window.findChildByName(const_975) as ITextWindow;
         var pointerWindow:IBitmapWrapperWindow = this._window.findChildByName(const_1350) as IBitmapWrapperWindow;
         ...
         if(this.var_257 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_797 = Math.max(0,(this.var_257.height - background.height) / 2);
               this.var_258 += userIconWindow.x + this.var_257.width;
            }
         }
         if(nameWindow != null)
         {
            ...
            this.var_258 += nameWindow.width;
         }
         if(this.var_1460 == RoomWidgetChatUpdateEvent.const_279)
         {
            textWindow.text = this.var_80.registerParameter("widgets.chatbubble.respect","username",this.var_965);
            this.var_258 = const_974;
         }
         else if(this.var_1460 == RoomWidgetChatUpdateEvent.const_284)
         {
            textWindow.text = this.var_80.registerParameter("widget.chatbubble.petrespect","petname",this.var_965);
            this.var_258 = const_974;
         }
         ...
         else
         {
            ...
            while(i < this.var_384.length)
            {
               ...
               this.var_798.push([placeholderPos,lastLinkEndPos]);
            ...
            i = 0;
            while(i < this.var_798.length)
            {
               linkPos = this.var_798[i];
               try
               {
         ...
         if(textWindow.visible)
         {
            ...
            this.var_258 += textWindow.width;
         }
         if(pointerWindow != null && pointerWindow.visible)
         {
            pointerWindow.bitmap = pointerBitmapData;
            pointerWindow.disposesBitmap = false;
            pointerWindow.x = this.var_258 / 2;
            pointerWindow.y += this.var_797;
         }
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2616,isRespect);
         this._window.width = bitmap.width;
         this._window.y -= this.var_797;
         this.var_258 = this._window.width;
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:ITextWindow = this._window.getChildByName(const_975) as ITextWindow;
         var _loc4_:int = _loc3_.getCharIndexAtPoint(param1 - _loc3_.x,param2 - _loc3_.y);
         if(_loc4_ > -1)
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_798.length)
            {
               if(_loc4_ >= this.var_798[_loc5_][0] && _loc4_ <= this.var_798[_loc5_][1])
               {
                  ...
                  {
                     HabboWebTools.openWebPage(this.var_1866 + this.var_384[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1866 + this.var_384[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         this._widget.onItemMouseClick(this.var_1199,this.var_965,this.var_1198,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1199,this.var_1198,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1199,this.var_1198,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1199,this.var_1198,this._roomId,this._roomCategory,param1);
      }
