package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2046:int = 1000;
      
      private var _container:MeMenuEffectsView;
      
      private var _window:IWindowContainer;
      
      private var var_187:IWidgetAvatarEffect;
      ...
      private var var_926:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_199 = new Timer(this.const_2046);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_187.isActive)
         {
            _loc2_ = this.var_187.secondsLeft / Number(this.var_187.duration);
            this.var_925.width = _loc2_ * this.var_305;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_750 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_750 == null)
            {
               return;
            }
         ...
         if(!this.var_187.isActive)
         {
            this.var_750.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_750.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_750.text;
         var _loc2_:int = this.var_187.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_187.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_187.isActive)
         {
         ...
         else
         {
            ...
            this.var_926 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_925 != null)
         {
            this.var_305 = this.var_925.width;
            this.var_199.start();
            this.onUpdate();
         }
         if(this.var_187.icon)
         {
            this.setElementBitmap("effect_icon",this.var_187.icon);
         }
      }
