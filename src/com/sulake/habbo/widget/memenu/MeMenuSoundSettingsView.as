package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_906:MeMenuSoundSettingsSlider;
      ...
      private var var_550:Number = 1.0;
      ...
      {
         this.var_550 = param1.volume;
         if(this.var_906 != null)
         {
            this.var_906.setValue(this.var_550);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1704 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1702 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1701 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1703 = (_loc5_.content as BitmapData).clone();
         }
         this.var_906 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1704);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1702);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_550 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1701);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1703);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_882);
         }
         else
         {
