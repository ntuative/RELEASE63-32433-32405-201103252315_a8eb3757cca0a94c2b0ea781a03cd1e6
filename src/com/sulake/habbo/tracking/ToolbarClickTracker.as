package com.sulake.habbo.tracking
{
   ...
   public class ToolbarClickTracker
   {
      ...
      private var var_1311:IHabboTracking;
      ...
      public function configure(param1:IHabboConfigurationManager) : void
      {
         ...
         this.var_2572 = parseInt(param1.getKey("toolbar.tracking.max.events","100"));
      }
      ...
      public function track(param1:String) : void
      {
         ...
         ++this.var_1827;
         if(this.var_1827 <= this.var_2572)
         {
            this.var_1311.track("toolbar",param1);
         }
      }
   }
}
