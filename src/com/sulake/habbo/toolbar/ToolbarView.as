package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1890:Number = 15;
      
      private var var_1889:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_171 = this._window.width;
         this.var_232 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_62,HabboWindowStyle.const_1136,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1216 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1216)
         {
         ...
         this.var_1890 = _loc8_.toolbar.@min_group_margin;
         this.var_1889 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_265,param1,param2,param3,this._window,this.var_310);
         this.createGroupsFromXmlList(_loc10_,this.var_644,param1,param2,param3,this.var_232,this.var_310);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_171);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_171,this.var_534,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_534);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_171,this.var_534);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_171,this.var_534);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_690);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_232.x = this.var_171 + this.var_1889;
               this.var_232.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_171;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_171;
               this._window.y = 0;
               this.var_232.x = 0;
               this.var_232.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_171;
               this._window.x = 0;
               this._window.y = 0;
               this.var_232.x = 0;
               this.var_232.y = this.var_171 + this.var_1889;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_171;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_171;
               this.var_232.x = 0;
               this.var_232.y = 0;
               _loc4_ = this._window.width;
         }
         ...
         else
         {
            ...
            if(this.var_265.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_1890,(this._window.height - _loc5_ * _loc8_ - this._toolbarMarginTop - this._toolbarMarginBottom) / (this.var_265.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1890,(this._window.width - _loc5_ * _loc8_ - this._toolbarMarginTop - this._toolbarMarginBottom) / (this.var_265.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_265.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_534;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1216 && this.var_1476)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_534)
            {
               this.var_534 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_546);
                  _loc3_.orientation = this.var_534;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_171)
         {
            return "RIGHT";
         }
         ...
         if(param2 >= _loc3_.height - this.var_171)
         {
            return "BOTTOM";
         }
         return null;
