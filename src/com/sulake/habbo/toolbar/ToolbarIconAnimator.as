package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1395 = param1.loop;
         if(param1.background != null)
         {
            this.var_743 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1395 == true || this.var_917 == 0)
         {
      ...
      {
         return this.var_1395 == false && this.var_917 == 1 && this.var_1721 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_743.width),Math.max(param2.height,this.var_743.height),true,0);
            _loc4_ = _loc3_.height - this.var_743.rect.height;
            _loc3_.copyPixels(this.var_743,this.var_743.rect,new Point(0,_loc4_),null,null,true);
