package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_2401:int = 5;
      
      private var var_2504:int;
      
      private var var_171:Number;
      
      private var var_2503:XML;
      ...
      {
         return this.var_1422.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2503.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_765.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_765.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1424.length)
         {
            _loc2_ = this.var_765.indexOf(this.var_1424[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_313[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_695 + _loc3_);
                  _loc3_ += this.var_1423;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_313[this.var_765.indexOf(param1)];
      }
