package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1376:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_327.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this.var_17 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_327.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1376 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_17 == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1154,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_133,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_518,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1052,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1037,this.onHideWindowEvent);
         this._state = true;
