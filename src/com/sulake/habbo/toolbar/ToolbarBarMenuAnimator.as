package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1342:Number = 25;
      
      private static const const_1357:Number = 90;
      
      private static const const_972:int = 50;
      
      private static const const_1343:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1438:ToolbarView;
      
      private var var_780:Timer;
      ...
      {
         this.var_374 = new Array();
         this._itemList = new Object();
         this.var_626 = new Object();
         this.var_628 = new Array();
         this.var_627 = new Array();
         super();
         this._windowManager = param1;
         this.var_1438 = param2;
         this.var_780 = new Timer(const_1342);
         this.var_780.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_374[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_972 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_972 || param1.desktop.height - param1.y < const_1343;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1438.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_374.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1438.getIconLoc(param1.iconId);
      ...
      {
         return this.var_628[this.var_627.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_627[this.var_628.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_627.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_627.splice(_loc3_,1);
            this.var_628.splice(_loc3_,1);
         }
         this.var_628.push(param1.name);
         this.var_627.push(param2);
         param1.addEventListener(WindowEvent.const_358,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_220,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_626[_loc3_] == null)
            {
               this.var_626[_loc3_] = new Array();
            }
            if(this.var_626[_loc3_].indexOf(param1) < 0)
            {
               this.var_626[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_374.indexOf(param1) > -1)
         {
            if(const_211)
            {
            ...
            else
            {
               ...
               this.var_374.splice(this.var_374.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_628[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_627[_loc2_];
               if(this.var_626[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_626[_loc3_].length)
                  {
                     this.repositionWindow(this.var_626[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_374.length)
         {
            _loc2_ = this._itemList[this.var_374[_loc7_]];
            if(_loc2_.active)
            {
