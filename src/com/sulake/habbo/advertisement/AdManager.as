package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1191:BitmapData = null;
      
      private var var_1189:BitmapData = null;
      ...
      {
         this.var_327 = param2 as IHabboCommunicationManager;
         if(this.var_327 == null)
         {
            return;
         }
         this._connection = this.var_327.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2590 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2589 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2591 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1847 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1190 == 0)
         {
            this.var_1190 = getTimer();
            return false;
         }
         if(this.var_1847 > 0 && this.var_1845 >= this.var_1847)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1190;
         if(_loc1_ > this.var_2589)
         {
            ++this.var_1845;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1454 = _loc2_.imageUrl;
         this.var_2592 = _loc2_.clickUrl;
         this.var_1190 = getTimer();
         if(this.var_1454 != "")
         {
            _loc3_ = this.var_1454;
            ...
            {
               this.var_226 = new Timer(this.var_2591,1);
            ...
            this.var_226.start();
            _loc4_ = new URLRequest(this.var_1454);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_545,0,0,param1.bitmapData,this.var_2592));
            this.var_1190 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_577));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1453 = _loc2_.imageUrl;
         this.var_1846 = _loc2_.clickUrl;
         if(this.var_1453 != "" && this.var_1846 != "")
         {
            _loc3_ = this.var_1453;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1453);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_540,0,0,_loc4_,this.var_1846,this.var_1191,this.var_1189));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1191 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1189 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
