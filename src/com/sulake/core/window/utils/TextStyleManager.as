package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_506:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_614:String = "{";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_87[const_189],var_87[ITALIC],var_87[BOLD]];
            var_87.reset();
            var_87[const_189] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_506.indexOf(_loc4_.name) == -1)
            {
               var_506.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_613);
         if(countSubStrings(param1,const_614) != countSubStrings(param1,const_613))
         {
            throw new Error("Mismatching amount of \"" + const_614 + "\" versus \"" + const_613 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1335) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1334) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_614)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
