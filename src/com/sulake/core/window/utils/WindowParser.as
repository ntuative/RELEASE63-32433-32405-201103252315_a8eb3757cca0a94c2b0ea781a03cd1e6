package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1872:String = "_INCLUDE";
      
      public static const const_1825:String = "_TEMP";
      
      private static const const_1413:String = "layout";
      
      private static const const_1002:String = "window";
      ...
      private static const const_1414:String = "style";
      
      private static const const_621:String = "params";
      
      private static const const_1405:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1420:String = "width";
      
      private static const const_1411:String = "height";
      
      private static const const_1408:String = "visible";
      
      private static const const_1416:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1099:String = "blend";
      
      private static const const_1419:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1406:String = "treshold";
      
      private static const const_1409:String = "children";
      
      private static const const_1417:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1404:String = "height_min";
      
      private static const const_1410:String = "height_max";
      
      private static const const_622:String = "true";
      
      private static const const_163:String = "0";
      
      private static const const_1407:String = "$";
      
      private static const const_1412:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1415:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1418:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1565:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1307,this.var_1308);
         this.var_1054 = new Dictionary();
         this.var_1565 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1054,this.var_1565);
         this.var_2093 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1418,const_49);
         return param1.replace(const_1415,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1054)
            {
               delete this.var_1054[_loc1_];
            }
            for(_loc1_ in this.var_1565)
            {
               delete this.var_1565[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1413)
         {
            ...
            _loc4_ = param1.child(const_1002);
         ...
         if(param1.localName() == const_1002)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1307[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_427,variables,"")));
         style = uint(this.parseAttribute(xml,const_1414,variables,style));
         params = uint(this.parseAttribute(xml,const_621,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1405,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_163));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_163));
         rect.width = Number(this.parseAttribute(xml,const_1420,variables,const_163));
         rect.height = Number(this.parseAttribute(xml,const_1411,variables,const_163));
         visible = this.parseAttribute(xml,const_1408,variables,visible.toString()) == const_622;
         ...
         if(xml.child(const_621).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_1054[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_427)) + "\"!");
               }
               params |= this.var_1054[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1416,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1412);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1417,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1404,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1410,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_622;
         blend = Number(this.parseAttribute(xml,const_1099,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1419,variables,window.clipping.toString()) == const_622;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1406,variables,window.mouseThreshold.toString()));
