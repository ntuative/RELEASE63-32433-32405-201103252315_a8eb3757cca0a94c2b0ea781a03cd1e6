package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_857:Dictionary;
      ...
      {
         super(param1);
         this.var_857 = new Dictionary(false);
         this.var_858 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_1013 = null;
            for(_loc1_ in this.var_857)
            {
               _loc2_ = this.var_857[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_857[_loc1_];
            }
            this.var_857 = null;
            for(_loc1_ in this.var_858)
            {
               _loc2_ = this.var_858[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_465[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_289)
                  {
                     var_36.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_511)
                  {
                     _loc12_ = true;
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_289)
                  {
                     var_36.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_511)
                  {
                     _loc13_ = true;
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_289)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_289)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_857[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_858[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
