package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1437:String = "skin";
      
      private static const const_1435:String = "bitmap";
      
      private static const const_1436:String = "fill";
      
      private static const const_1438:String = "text";
      
      private static const const_1433:String = "label";
      
      private static const const_1434:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "ScrollbarController";
      ...
      private var var_2828:Dictionary;
      
      private var var_2827:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2828 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2014,this.var_2828);
         this.var_2827 = new Dictionary();
         this.var_2829 = new Dictionary();
         StateCodeTable.fillTables(this.var_2827,this.var_2829);
         this.var_461 = new Dictionary();
         this.var_461[const_1437] = BitmapSkinRenderer;
         this.var_461[const_1435] = BitmapDataRenderer;
         this.var_461[const_1436] = FillSkinRenderer;
         this.var_461[const_1438] = TextSkinRenderer;
         this.var_461[const_1433] = LabelRenderer;
         this.var_461[const_1434] = ShapeSkinRenderer;
         this.var_461[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_461[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_339 == null)
         {
            var_339 = new Array();
            var_339.push(WindowState.const_64);
            var_339.push(WindowState.const_82);
            var_339.push(WindowState.const_98);
            var_339.push(WindowState.const_55);
            var_339.push(WindowState.const_96);
            var_339.push(WindowState.const_83);
            var_339.push(WindowState.const_107);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2841 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2014[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1036[param1] == null)
         {
            this.var_1036[param1] = new Array(const_1016);
         }
         this.var_1036[param1][param2] = param3;
         if(this.var_1035[param1] == null)
         {
            this.var_1035[param1] = new Array(const_1016);
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1036[param1];
         if(_loc3_)
         {
