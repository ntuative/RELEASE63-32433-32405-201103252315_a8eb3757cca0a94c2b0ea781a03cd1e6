package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2318 = _loc2_.textWidth;
         this.var_2317 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_352 != _loc2_.color : this.var_352 != null && this.var_352 != PropertyDefaults.const_819) ? new PropertyStruct(PropertyDefaults.const_354,this.var_352,PropertyStruct.const_130,true) : PropertyDefaults.const_1058);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_921)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_222,this.var_40.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_512);
            }
            if(this.var_40.top != PropertyDefaults.const_682)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_245,this.var_40.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_489);
            }
            if(this.var_40.right != PropertyDefaults.const_751)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,this.var_40.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_576);
            }
            if(this.var_40.bottom != PropertyDefaults.const_653)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,this.var_40.bottom,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_434);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_356:
                  ...
                  break;
               case PropertyDefaults.const_354:
