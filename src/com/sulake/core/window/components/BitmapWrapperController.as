package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_560 != PropertyDefaults.const_1020)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_670,this.var_560,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1457);
         }
         if(this.var_851 != PropertyDefaults.const_1069)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_897,this.var_851,PropertyStruct.const_54,true));
         }
         else
         {
