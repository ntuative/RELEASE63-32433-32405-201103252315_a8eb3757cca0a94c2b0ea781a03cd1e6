package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1354:String = "_SELECTOR";
      
      private static const const_1353:String = "_CONTENT";
       
      
      protected var var_1051:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1051 = findChildByTag(const_1354) as ITabSelectorWindow;
            if(this.var_1051 != null)
            {
               this.var_1051.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2087 = findChildByTag(const_1353) as IWindowContainer;
         }
      ...
      {
         return !!this.var_782 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1051.numSelectables;
      }
