package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_876:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_875:String = "default";
      
      private var var_1094:String = null;
      
      private var var_1614:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1094 == param2)
         {
            return;
         }
         param1.var_1094 = param2;
         param1.var_1614 = null;
         if(param1.var_1094 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1094);
            param1.var_1614 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_789.indexOf(param1) > -1)
         {
            this.var_875 = param1;
         }
      }
      ...
      {
         return this.var_875 == LinkTarget.const_32 ? defaultLinkTarget : this.var_875;
      }
      ...
      override public function set text(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_21);
            refreshTextImage();
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_21);
            _field.styleSheet = this.var_1614;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_709)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_807,this.var_875,PropertyStruct.const_54,true,PropertyDefaults.const_789));
         }
         else
         {
