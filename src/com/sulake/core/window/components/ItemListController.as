package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2091:Boolean = false;
      ...
      protected var var_2907:Number = 0.0;
      
      protected var var_2906:Number = 0.0;
      ...
      protected var var_2092:int = 0;
      
      protected var var_2090:int = 0;
      
      protected var var_1305:Number;
      
      protected var var_1306:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_178 = var_469 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_364,WindowStyle.const_834,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_47,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_516,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_323,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_444,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1303;
      }
      ...
      {
         return new Rectangle(this.var_694 * this.maxScrollH,this.var_693 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_694 = param1;
            this._container.x = -this.var_694 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.REDRAW);
            dispatchEvent(new WindowEvent(WindowEvent.const_599,this,null));
         }
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_693 = param1;
            this._container.y = -this.var_693 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.REDRAW);
            dispatchEvent(new WindowEvent(WindowEvent.const_599,this,null));
         }
      }
      ...
      {
         this.var_2907 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2906 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_522,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_594,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_516,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_323,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_444,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_188:
               if(this.var_1304)
               {
                  this.var_1305 = this.var_2092 - _loc3_;
                  this.var_1306 = this.var_2090 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1305 != 0 && this.var_112 != 0)
                     {
                        this.scrollH += this.var_1305 / this.var_112;
                     }
                  }
                  else if(this.var_1306 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1306 / this.var_95;
                  }
                  this.var_2092 = _loc3_;
                  this.var_2090 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_197:
               if(this.var_1304)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1305,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1306);
                  }
                  this.var_1304 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1053 && !this.var_566 && this._container)
         {
            this.var_566 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_755)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_357,this._spacing,PropertyStruct.const_41,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1128);
         }
         if(this.var_1053 != PropertyDefaults.const_1250)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_889,this.var_1053,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1598);
         }
         if(this.var_472 != PropertyDefaults.const_1116)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_794,this.var_472,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1643);
         }
         if(this.var_1303 != PropertyDefaults.const_1050)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_813,this.var_1303,PropertyStruct.const_37,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_889:
                  this.var_1053 = _loc2_.value as Boolean;
                  break;
            }
         }
