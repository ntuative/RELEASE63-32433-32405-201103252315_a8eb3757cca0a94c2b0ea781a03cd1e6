package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1295:String = "_TITLE";
      
      private static const const_1292:String = "_HEADER";
      
      private static const const_1294:String = "_CONTENT";
      
      private static const const_1293:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1368:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1295) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1368 = findChildByTag(const_1292) as IHeaderWindow;
            if(!this.var_1368)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_190 = findChildByTag(const_1294) as IWindowContainer;
            if(!this.var_190)
            {
      ...
      {
         return findChildByTag(const_1293) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1045 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_222,_loc3_.left,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_245,_loc3_.top,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_268,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         }
         else
         {
