package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_419:String = "_DROPMENU_TITLETEXT";
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_543,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_653 = param1;
            this.closeMenuView();
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_396,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      {
         return getChildByName(DropMenuController.const_419) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_194 == null || this.var_194.disposed)
         {
            this.var_194 = context.create(name + "::submenu","",WindowType.const_548,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_991 = false;
            this.getTitleLabel().text = this.var_653 < this.var_270.length && this.var_653 > -1 ? this.var_270[this.var_653] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_551,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         param2.activate();
         if(this.var_653 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_653).setStateFlag(WindowState.const_55,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_DOWN || param1.type == WindowTouchEvent.const_499)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1151:
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1237,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_270.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_656,this.var_270,PropertyStruct.const_151,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_656)
            {
