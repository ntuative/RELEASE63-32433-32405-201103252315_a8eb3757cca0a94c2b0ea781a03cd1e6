package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1098:IItemListWindow;
      
      private var var_415:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_415)
         {
            this.var_415.removeEventListener(WindowEvent.const_287,this.scrollBarEventProc);
            this.var_415.removeEventListener(WindowEvent.const_220,this.scrollBarEventProc);
            this.var_415 = null;
         }
         if(this.var_1098)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1098)
         {
            this.var_1098 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_415)
         {
            this.var_415 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_415)
            {
               this.var_415.addEventListener(WindowEvent.const_287,this.scrollBarEventProc);
               this.var_415.addEventListener(WindowEvent.const_220,this.scrollBarEventProc);
            }
         }
         return this.var_415;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_220)
         {
            this.hideScrollBar();
         }
      }
