package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1564:uint = 500;
      ...
      {
         this.var_1300 = param1 == null ? "" : param1;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_398,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_859,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1521);
         _loc1_.push(this.var_1297 != PropertyDefaults.const_1225 ? new PropertyStruct(PropertyDefaults.const_895,this.var_1297,PropertyStruct.const_37,true) : PropertyDefaults.const_1679);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1214 ? new PropertyStruct(PropertyDefaults.const_646,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1546);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1244 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1692);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_895:
                  this.var_1297 = _loc2_.value as Boolean;
                  if(this.var_1297)
                  {
               ...
               case PropertyDefaults.const_859:
                  ...
                  break;
               case PropertyDefaults.const_1109:
