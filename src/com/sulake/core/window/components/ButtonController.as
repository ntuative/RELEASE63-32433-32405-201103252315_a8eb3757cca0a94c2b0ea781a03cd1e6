package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_419:String = "_BTN_TEXT";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = getChildByName(const_419);
         if(_loc2_ != null)
         {
         ...
         if(event is WindowNotifyEvent)
         {
            switch(event.type)
            {
               ...
               case WindowNotifyEvent.const_762:
                  try
                  {
                     getChildByName(const_419).blend = getChildByName(const_419).blend + 0.5;
                  }
                  catch(e:Error)
                  {
                  }
