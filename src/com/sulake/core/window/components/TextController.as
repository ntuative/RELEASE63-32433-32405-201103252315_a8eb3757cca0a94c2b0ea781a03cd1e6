package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1263:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_856:Number;
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_127)
         {
            param1.context.removeLocalizationListener(param1.var_21.slice(2,param1.var_21.indexOf("}")),param1);
            param1.var_127 = false;
         }
         param1.var_21 = param2;
         if(param1.var_21.charAt(0) == "$" && param1.var_21.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_21.slice(2,param1.var_21.indexOf("}")),param1);
            param1.var_127 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_21;
            param1.refreshTextImage();
         }
      }
      ...
      {
         this.var_856 = param1;
         this._field.scrollH = this.var_856 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_856 * this.maxScrollH,this.var_564 * this.maxScrollV,width,height);
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         if(this.var_127)
         {
            context.removeLocalizationListener(var_21.slice(2,var_21.indexOf("}")),this);
            this.var_127 = false;
         }
         var_21 = param1;
         if(var_21.charAt(0) == "$" && var_21.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_21.slice(2,var_21.indexOf("}")),this);
            this.var_127 = true;
         }
         else if(this._field != null)
         {
            this._field.text = var_21;
            this.refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1118) ? new PropertyStruct(PropertyDefaults.const_665,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1127) : PropertyDefaults.const_1496);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1075 ? new PropertyStruct(PropertyDefaults.const_695,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1063) : PropertyDefaults.const_1646);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_130,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_231,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1025 ? new PropertyStruct(PropertyDefaults.const_1105,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1155) : PropertyDefaults.const_1609);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_819) ? new PropertyStruct(PropertyDefaults.const_354,this._field.textColor,PropertyStruct.const_130,true) : PropertyDefaults.const_1058);
         _loc1_.push(this.var_453 != TextStyleManager.const_189 ? new PropertyStruct(PropertyDefaults.const_356,this.var_453,PropertyStruct.const_54,true,PropertyDefaults.const_887) : PropertyDefaults.const_1084);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_921 ? new PropertyStruct(PropertyDefaults.const_222,this.var_40.left,PropertyStruct.const_41,true) : PropertyDefaults.const_512);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_682 ? new PropertyStruct(PropertyDefaults.const_245,this.var_40.top,PropertyStruct.const_41,true) : PropertyDefaults.const_489);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_751 ? new PropertyStruct(PropertyDefaults.const_228,this.var_40.right,PropertyStruct.const_41,true) : PropertyDefaults.const_576);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_653 ? new PropertyStruct(PropertyDefaults.const_268,this.var_40.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_434);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1257 ? new PropertyStruct(PropertyDefaults.const_812,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1445);
