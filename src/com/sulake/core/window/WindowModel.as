package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_691:Boolean = true;
      
      protected var var_322:Boolean = true;
      
      protected var var_815:Number = 1.0;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this._type = param3;
         this.var_20 = param5;
         this._state = WindowState.const_95;
         this.var_84 = param4;
         this.var_855 = param8 == null ? new Array() : param8;
