package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1050:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1050 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_471 = new AssetLibrary("lib-" + this.var_567++);
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1050;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_567++);
      ...
      public function method_3(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_471.method_3(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
         {
            _loc4_ = this.var_30[_loc6_];
            _loc5_ = _loc4_.method_3(param1,false);
            if(_loc5_ != null)
            {
               return _loc5_;
            }
