package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1258:String = "AssetLibraryReady";
      
      public static const const_691:String = "AssetLibraryLoaded";
      
      public static const const_1473:String = "AssetLibraryUnloaded";
      
      public static const const_1517:String = "AssetLibraryLoadError";
      
      private static const const_427:String = "name";
      
      private static const const_943:String = "asset";
      
      private static const const_941:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_942:String = "library";
      
      private static var var_302:Dictionary;
      
      private static var var_1615:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_483:uint = 0;
      
      private static var var_877:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_483;
         this.var_412 = new Dictionary(false);
         this.var_482 = new Dictionary(false);
         this.var_878 = new Dictionary(false);
         this.var_158 = new Dictionary(false);
         var_877.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_583 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_942);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_941);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_583 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_877.splice(var_877.indexOf(this),1);
            --var_483;
            this.var_482 = null;
            this.var_878 = null;
            this.var_158 = null;
      ...
      {
         if(this.var_583 == param1.url && this.var_879)
         {
            if(!this.var_880 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_584);
            }
            this.var_880 = param2;
      ...
      public function unload() : void
      {
         ...
         this.var_879 = false;
         this.var_583 = null;
         dispatchEvent(new Event(AssetLibrary.const_1473));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_878[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1184,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_158[struct.assetName] == null)
                  {
                     ++this.var_411;
                     this.var_413.push(struct.assetName);
                  }
                  this.var_158[struct.assetName] = asset;
               }
               else
               {
      ...
      {
         var _loc2_:IAsset = this.var_158[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_413.length ? this.getAssetByName(this.var_413[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_158)
         {
            if(this.var_158[_loc2_] == param1)
            {
               return this.var_413.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_158[param1] != null || (this.var_584 != null ? this.var_584[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_158[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1615.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_158)
            {
               if(this.var_158[_loc2_] == param1)
               {
                  this.var_413.splice(this.var_413.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_412.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_412[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_412[param1]);
      }
      
      public function method_3(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param2)
         ...
         for(_loc4_ in this.var_412)
         {
            _loc3_ = AssetTypeDeclaration(this.var_412[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_412)
         {
            _loc4_ = AssetTypeDeclaration(this.var_412[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_584 = _loc2_.resource;
         this.var_583 = _loc2_.url;
         if(this.var_880)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_584);
         }
         this.var_879 = true;
         dispatchEvent(new Event(AssetLibrary.const_691));
         dispatchEvent(new Event(AssetLibrary.const_1258));
         if(this.var_880)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_942);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_427).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_583 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_584[param1]);
                  _loc6_ = _loc3_.child(const_941);
                  if(_loc6_.length())
                  {
