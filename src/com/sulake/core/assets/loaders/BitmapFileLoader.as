package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1049 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1050 = new LoaderContext();
         this.var_1050.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1050);
         }
      }
      ...
      {
         this.var_1049 = param1.url;
         var_335 = 0;
         this.var_43.load(param1,this.var_1050);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_335 < var_2842)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1049 + (this.var_1049.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_335),this.var_1050);
               return true;
            }
         }
         return false;
