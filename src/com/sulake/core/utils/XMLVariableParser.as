package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1584:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1614:String = "bool";
      ...
      private static const const_628:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_627:String = "value";
      
      private static const const_622:String = "true";
      
      private static const const_1796:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_628);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_628));
         }
         else
         {
            _loc4_ = param1.child(const_628)[0];
         }
         ...
         _loc7_ = param1.attribute(const_627);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_627));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_627)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_218 || _loc5_ == const_151)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1584:
               return Number(param1);
            case const_37:
               return param1 == const_622 || int(param1) > 0;
            case const_1614:
               return param1 == const_622 || int(param1) > 0;
            case const_130:
               return uint(param1);
            case const_151:
               return param1.split(const_1412);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_271:
               ...
               _loc5_.width = Number(param1.attribute(const_1420));
               _loc5_.height = Number(param1.attribute(const_1411));
               return _loc5_;
            case const_151:
               _loc3_ = new Map();
