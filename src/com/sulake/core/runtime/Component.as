package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_420:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1863:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1147:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1299 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1299);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1367 & const_1147)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_992 = false;
            this._events.dispatchEvent(new LockEvent(const_420,this));
         }
      }
