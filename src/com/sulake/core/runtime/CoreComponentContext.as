package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1286:String = "library";
      
      private static const const_1285:String = "service-libraries";
      
      private static const const_1284:String = "library";
      
      private static const const_1290:String = "component-libraries";
      
      private static const const_1289:String = "library";
      
      private static const const_1287:String = "error_data";
      
      private static const const_1288:String = "error_cat";
      
      private static const const_1283:String = "error_desc";
       
      
      private var var_353:LibraryLoaderQueue;
      
      private var var_718:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_877:
               ...
               var_405.addChild(new ProfilerViewer(this.var_200));
               break;
            case Core.const_498:
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1287,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1288,String(param3));
         ErrorReportStorage.setParameter(const_1283,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_718 = loadingEventDelegate;
         if(this.var_353 == null)
         {
         ...
         try
         {
            node = config.child(const_1290)[0];
            if(node != null)
            {
               list = node.child(const_1289);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1624);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_718)
         {
            this.var_718.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_718)
         {
            ...
            this.var_718.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_718)
                  {
                     this.var_718.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_490 - this.var_353.length,this.var_490,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_200 ? 0 : this.var_1367 & 0;
         if(_loc3_ == Core.const_498)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_101)
         {
            ...
            {
               if(this.var_595[priority] < priority)
               {
                  ++this.var_595[priority];
                  skip = true;
               }
            }
            if(!skip)
