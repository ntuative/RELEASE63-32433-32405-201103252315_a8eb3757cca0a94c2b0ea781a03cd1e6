package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1546:int = 128;
      
      private var var_1547:Boolean = false;
      
      private var var_2897:Point;
      ...
      {
         if(param1 != this.var_2006 || param2 != this.var_2007)
         {
      ...
      {
         if(this.var_1546 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_258 || param2 >= this._height)
         {
            return false;
         }
