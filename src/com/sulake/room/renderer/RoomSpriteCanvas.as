package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_625:Point = new Point(0,0);
      
      private static const const_344:int = 50;
      
      private static const const_1384:int = 50;
      
      private static const const_989:Number = 60;
      
      private static const const_1385:Number = 50;
      ...
      private var var_269:BitmapDataCache;
      ...
      private var var_1479:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2667:Number = -1.0E7;
      
      private var var_2666:Number = -1.0E7;
      ...
      private var var_987:Matrix;
      
      private var var_484:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_268.addChild(this.var_102);
         ...
         this.var_269 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         this.var_536.x -= param1 - this.var_652;
         this.var_652 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_536.y -= param1 - this.var_648;
         this.var_648 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1030 = true;
            if(this.var_143 != null && !this.var_268.contains(this.var_143))
            {
               this.var_268.addChild(this.var_143);
               this.var_102.mask = this.var_143;
            }
         }
         else if(!param1 && this.var_1030)
         {
            ...
            if(this.var_143 != null && this.var_268.contains(this.var_143))
            {
               this.var_268.removeChild(this.var_143);
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_808 != this.var_2664 || this.var_806 != this.var_2668)
         {
            _loc8_ = true;
         }
         if(this.var_102.x != this.var_652 || this.var_102.y != this.var_648)
         {
            this.var_102.x = this.var_652;
            this.var_102.y = this.var_648;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_537.sortOn("z",0 | 0);
         if(_loc5_ < this.var_537.length)
         {
            this.var_537.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_537[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2664 = this.var_808;
         this.var_2668 = this.var_806;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1478 > 0)
         {
            ...
            if(_loc2_ > const_989 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2669 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_809;
               if(this.var_809 == const_344 + 1)
               {
                  this.var_484 = _loc2_;
                  this.var_1895 = this.var_2665;
               }
               else if(this.var_809 > const_344 + 1)
               {
                  _loc3_ = Number(this.var_809 - const_344);
                  this.var_484 = this.var_484 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1895 = this.var_1895 * (_loc3_ - 1) / _loc3_ + Number(this.var_2665) / _loc3_;
                  if(this.var_809 > const_344 + const_1384)
                  {
                     this.var_809 = const_344;
                     if(!this.var_1224 && this.var_484 > const_989)
                     {
                        this.var_1224 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1224 && this.var_484 < const_1385)
                     {
                        this.var_1224 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1896 && this.var_1224);
         ...
         _loc13_ += int(this.var_808 / 2);
         _loc14_ += int(this.var_806 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc19_ < this.var_808 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_806 && _loc20_ + _loc22_.height >= 0))
                  {
      ...
      {
         if(param1 < 0 || param1 >= this.var_989)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_989)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_807 || this.var_807 == 0)
         {
            _loc4_ = this.var_989 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_537[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_269.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_269.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_269.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_987.identity();
            this.var_987.scale(-1,1);
            this.var_987.translate(data.width,0);
            finalData.draw(data,this.var_987);
            if(name.length > 0)
            {
               this.var_269.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_625);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_988.redMultiplier = tR;
            this.var_988.greenMultiplier = tG;
            this.var_988.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_988);
            if(name.length > 0)
            {
               this.var_269.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_652;
         param2 -= this.var_648;
         this.var_536.x = param1;
         this.var_536.y = param2;
         if(this.var_1223 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1897;
         }
         this.var_1897 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1223;
         return this.var_1897;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_808 / 2;
         var _loc12_:Number = param2 - this.var_806 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1894,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2667 || param2 != this.var_2666)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_390.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1479.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1223 == 0)
         {
            this.checkMouseHits(this.var_536.x,this.var_536.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1223 = 0;
         ++this.var_1894;
      }
