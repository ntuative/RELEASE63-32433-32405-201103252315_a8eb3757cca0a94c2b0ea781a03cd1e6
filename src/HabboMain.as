package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_931:Number = 0.71;
      ...
      private var var_1311:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1311 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1311 && !this.var_1311.disposed)
                  {
                     this.var_1311.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_931 + this.var_24.getNumberOfFilesLoaded() / _loc11_ * const_931;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
